...
{
public:
    GEOMENT_DECLARE_MEMBERS(AcDbAssocPatchSurfaceActionBody);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject explanation. </param>
    ///
    ACDB_PORT explicit AcDbAssocPatchSurfaceActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDB_PORT Acad::ErrorStatus setConstraintPoints( const AcArray<AcDbVertexRef> & constraintPoints);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus setConstraintCurves( const AcArray<AcDbEdgeRef> & constraintCurves );
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus setContinuity(int continuity, const AcString& expression = AcString(), 
    ...
    ///
    ACDB_PORT int continuity(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus getContinuityGripPoint ( AcGePoint3d&  gripPt) const;
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus setBulge(double bulge, const AcString& expression = AcString(), 
        const AcString& evaluatorId = AcString());
    ...
    ///
    ACDB_PORT double bulge(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT static Acad::ErrorStatus createInstance( const AcDbObjectId& patchSurfaceId,
