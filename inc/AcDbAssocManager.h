...
{
public:     
    ACDB_DECLARE_MEMBERS(AcDbAssocManager);

    /// <summary> Default constructor. </summary>
    ///
    ACDBCORE2D_PORT AcDbAssocManager();
    ...
    ///
    ACDBCORE2D_PORT static bool evaluateTopLevelNetwork(AcDbDatabase*                pDatabase,
    ...
    ///
    ACDBCORE2D_PORT static AcDbAssocEvaluationCallback* globalEvaluationMultiCallback();
    ...
    /// </returns>
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus addGlobalEvaluationCallback(AcDbAssocEvaluationCallback* pCallback, int order);
    ...
    /// </returns>
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus removeGlobalEvaluationCallback(AcDbAssocEvaluationCallback* pCallback);
    ...
    ///
    ACDBCORE2D_PORT static void getGlobalEvaluationCallbacks(AcArray<AcDbAssocEvaluationCallback*>& callbacks,
                                             AcArray<int>&                          orders);
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT static bool isActionEvaluationInProgress(const AcDbDatabase*);
    ...
    /// </para></summary>
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus requestToEvaluate(const AcDbObjectId& objectId, 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT static AcDbAssocEvaluationCallback* getCurrentEvaluationCallback(const AcDbDatabase*);
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT static bool hasAssocNetwork(const AcDbDatabase* pDatabase);
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT static AcDbObjectId currentlyEvaluatedAction(const AcDbDatabase*);
    ...
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus auditAssociativeData(AcDbDatabase* pDatabase, bool traverseWholeDatabase);
    ...
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus markSyncUpWithXrefsNeeded(AcDbDatabase* pDatabase);
    ...
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus syncUpWithXrefs(AcDbDatabase* pHostDatabase);
    ...
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus initialize();
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT static void uninitialize();
    ...
    ///
    ACDBCORE2D_PORT static void enableProgressMeter(bool enableIt, const AcString& progressLabel = AcString());
...
{
public:
    ACDBCORE2D_PORT explicit AcDbAssocNetworkEvaluationDisabler(AcDbDatabase*, bool disableIt = true);
    ACDBCORE2D_PORT ~AcDbAssocNetworkEvaluationDisabler();
    ACDBCORE2D_PORT static bool isDisabled(const AcDbDatabase*);
