...
public:
	...
	// Copy constructor.
	//
	GE_DLLEXPIMPORT AcGeClipBoundary2d (const AcGeClipBoundary2d& src);
    ...
    //
    GE_DLLEXPIMPORT AcGe::ClipError		clipPolyline(const AcGePoint2dArray& rawVertices, 
                                     AcGePoint2dArray& clippedVertices,
                                     AcGe::ClipCondition& clipCondition,
                                     AcGeIntArray* pClippedSegmentSourceLabel = 0) const;
    ...
    // Assignment operator.
    //
    GE_DLLEXPIMPORT AcGeClipBoundary2d& operator = (const AcGeClipBoundary2d& crvInt);
};
