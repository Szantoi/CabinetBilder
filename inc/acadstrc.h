...
//////////////////////////////////////////////////////////////////////////////
//
// acadstrc.h:   definition of Acad struct which contains the
//               ErrorStatus enumerated type values

#ifndef AD_ACADSTRC_H
#define AD_ACADSTRC_H 1

// Enable this macro to use stricter type checking on the ErrorStatus
// enum type, and uncover various mis-uses such as treating it as a bool
//
// #define Acad_ErrorStatus_Scoped

struct Acad
{
    enum

#ifdef  Acad_ErrorStatus_Scoped
            class
#endif
            ...
            ErrorStatus {
                             ...
                             // Status codes for Spatial Reference System
                             eSrsCompoundCrsDatumNotMatch   = 1500,
                             eSrsCompoundCrsUnitNotMatch    = 1501,
...
#if defined(Acad_ErrorStatus_Scoped) && __cpp_using_enum
    using enum ErrorStatus;
#endif
