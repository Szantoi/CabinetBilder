...
/// </summary>
///
class  AcDbAssocSurfaceActionBody : public AcDbAssocParamBasedActionBody
{
public: 
    GEOMENT_DECLARE_MEMBERS(AcDbAssocSurfaceActionBody);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject. </param>
    ///
    ACDB_PORT explicit AcDbAssocSurfaceActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    /// </para></summary>
    ///
    ACDB_PORT AcDbObjectId resultingSurfaceDep(bool createIfDoesNotExist, bool isWriteOnlyDependency = true);
    ...
    /// </summary>
    ///
    ACDB_PORT AcDbObjectId resultingSurface() const;
    ...
    /// </para></summary>
    ///
    ACDB_PORT Acad::ErrorStatus setResultingSurface(const AcDbObjectId& surfaceId, bool isWriteOnlyDependency = true);
    ...
    /// </para></summary> 
    ///
    ACDB_PORT bool isSemiAssociative() const;
    ...
    /// </summary>
    ///
    ACDB_PORT virtual bool isSemiAssociativitySatisfiedOverride() const;
    ...
    /// <summary> Overridden implementation of the base class method. </summary>
    ///
    ACDB_PORT Acad::ErrorStatus getDependentActionsToEvaluateOverride(AcDbActionsToEvaluateCallback*) const override;

    /// <summary> Overridden implementation of the base class method. </summary>
    ///
    ACDB_PORT Acad::ErrorStatus addMoreObjectsToDeepCloneOverride(
        AcDbIdMapping&, AcDbObjectIdArray& additionalObjectsToClone) const override;

    /// <summary> Overridden implementation of the base class method. </summary>
    ///
    ACDB_PORT Acad::ErrorStatus dragStatusOverride(const AcDb::DragStat) override;
    ...
    /// </remarks>
    ///
    ACDB_PORT static Acad::ErrorStatus findActionsThatAffectedTopologicalSubentity(
    ...
    /// </remarks>
    ///
    ACDB_PORT static Acad::ErrorStatus getTopologicalSubentitiesForActionsOnEntity(
        const AcDbEntity*                pAsmBasedEntity,
    ...
    /// </summary>
    ///
    ACDB_PORT static Acad::ErrorStatus getSurfacesDirectlyDependentOnObject(
        const AcDbObject*, 
    ...
    /// </summary>    
    ///
    ACDB_PORT virtual Acad::ErrorStatus getGripPoints( 
    ...
    /// </summary>    
    ///
    ACDB_PORT virtual Acad::ErrorStatus moveGripPoints( 
    ...
    /// </summary>    
    ///
    ACDB_PORT virtual Acad::ErrorStatus moveStretchPoints( 
        const AcDbIntArray& indices,
        const AcGeVector3d& offset);
    ...
    /// </summary>    
    ///
    ACDB_PORT virtual void gripStatus(const AcDb::GripStat status);
    ...
    /// </summary>    
    ///
    ACDB_PORT virtual Acad::ErrorStatus getGripEntityUCS( 
    ...
    /// </summary>    
    ///
    ACDB_PORT virtual void list() const;
