...
public:
    ...
    AcadInternalServices * acadInternalServices2()      // obsolete
    {
        return this->acadInternalServices();
    }
    ...
    // This overload calls the above virtual overload.
    //
