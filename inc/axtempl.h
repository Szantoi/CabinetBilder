...
{
public:
    using IConnectionPointImpl<T, &IID_IAcadObjectEvents, CComDynamicUnkArray>::m_vec;
...
{
public:
    using IConnectionPointImpl<T, &IID_IPropertyNotifySink, CComDynamicUnkArray>::m_vec;
...
{
protected:
    using IAcadBaseObjectImpl<T, pclsid>::m_objId;
public:
...
{
protected:
    using IDispatchImpl<T, piid, plibid, wMajor, wMinor, tihclass>::_tih;
    using IAcadBaseObject2Impl<C, pclsid>::m_objRef;
public:
...
{
protected:
    using IAcadObjectDispatchImpl<C, pclsid, T, piid, plibid, wMajor, wMinor, tihclass>::m_objRef;
    using IAcadObjectDispatchImpl<C, pclsid, T, piid, plibid, wMajor, wMinor, tihclass>::m_App;
public:
...
{
protected:
    using IAcadEntityDispatchImpl<C, pclsid, T, piid, plibid, wMajor, wMinor, tihclass>::m_objId;
public:
