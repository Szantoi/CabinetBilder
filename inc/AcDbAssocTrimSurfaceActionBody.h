...
{
public:
    GEOMENT_DECLARE_MEMBERS(AcDbAssocTrimSurfaceActionBody);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject explanation. </param>
    ///
    ACDB_PORT explicit AcDbAssocTrimSurfaceActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDB_PORT Acad::ErrorStatus setTrimInfo(const AcArray<AcDbSurfaceTrimInfo> trimInfoArray, bool bAutoExtend);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///   
    ACDB_PORT Acad::ErrorStatus makeTrimPermanent();
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///   
    ACDB_PORT Acad::ErrorStatus untrim();
    ...
    ///
    ACDB_PORT double getTrimmedArea() const;
