...
public:
    ...
    enum SetAttributesFlags
    {
        ...
        // Drawable supports threaded worldDraw/viewportDraw calls
        kThreadedWorldDrawViewportDraw          = 131072,

        // Drawable manages the lifetime of child drawables
        kDrawableManagesChildDrawables          = 262144,

        // When this flag is set, the drawable does not reset GsMarker
        // to 0 and instead uses what the parent drawable last set. This 
        // flag makes 3D behave like 2D Wireframe in this regard.
        kDrawableInheritsSelectionMarker        = 524288
    };
...
private:
    ...
    AcGiImpDrawable* mpImpObject = nullptr;
};
...
public:
    ...
    ACDBCORE2D_PORT virtual void handOverTo (AcGiDrawable* /*pDrawableFrom*/, AcGiDrawable* /*pDrawableTo*/) {}
    ...
    ACDBCORE2D_PORT virtual void erased(AcGiDrawable* /*pDrawable*/, Adesk::IntDbId /*parentID*/) {}
    ...
    /// <param name="pDrawable">Input drawable whose graphics were modified.</param>
    /// <param name="parentID">Input id of parent drawable.</param>
    ACDBCORE2D_PORT virtual void modified(AcGiDrawable* /*pDrawable*/, Adesk::IntDbId /*parentID*/) {}
    ...
    ACDBCORE2D_PORT virtual void added(AcGiDrawable* /*pDrawable*/, Adesk::IntDbId /*parentID*/, Adesk::LongPtr /*databasePtr*/) {}
};
