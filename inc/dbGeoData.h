...
public:
    ...
    /// <summary>
    /// This method will be called when either the coordinate system or the vertical coordinate system
    /// is about to change.
    /// Custom classes can return Acad::eVetoed to veto the change. Once custom classes override
    /// this method, geoCoordinateSystemWillChange(AcDbDatabase*, const AcString&, const AcString&)
    /// won't be called.
    /// </summary>
    ///
    /// <param name="pDb">
    ...
    ///
    /// <param name="oldVcsId">
    /// The vertical coordinate system ID that is about to be replaced.
    /// </param>
    ///
    /// <param name="newCsId">
    /// The coordinate system ID that is about to be set.
    ...
    ///
    /// <param name="newVcsId">
    /// The vertical coordinate system ID that is about to be set.
    /// </param>
    ///
    /// <returns>Custom classes can return Acad::eVetoed to veto the change.</returns>
    ///
    virtual Acad::ErrorStatus geoCoordinateSystemWillChange(AcDbDatabase* pDb, const AcString& oldCsId, const AcString& /*oldVcsId*/, const AcString& newCsId, const AcString& /*newVcsId*/)
    {
        return oldCsId != newCsId ? geoCoordinateSystemWillChange(pDb, oldCsId, newCsId) : Acad::eOk;
    }

    /// <summary>
    /// This method will be called after either the coordinate system or the vertical coordinate system
    /// has been changed.
    /// Once custom classes override this method, geoCoordinateSystemChanged(AcDbDatabase*, const AcString&,
    /// const AcString&) won't be called.
    /// </summary>
    ///
    /// <param name="pDb">
    /// The database where the AcDbGeoData object resides.
    ...
    ///
    /// <param name="oldVcsId">
    /// The vertical coordinate system ID that has been replaced.
    /// </param>
    /// 
    /// <param name="newCsId">
    /// The newly set coordinate system ID.
    ...
    ///
    /// <param name="newVcsId">
    /// The newly set vertical coordinate system ID.
    /// </param>
    /// 
    virtual void geoCoordinateSystemChanged(AcDbDatabase* pDb, const AcString& oldCsId, const AcString& /*oldVcsId*/, const AcString& newCsId, const AcString& /*newVcsId*/)
    {
        if (oldCsId != newCsId)
            geoCoordinateSystemChanged(pDb, oldCsId, newCsId);
    }
};
...
public:
    ...
    /// For the ID, it contains either only a geodetic CRS or geodetic and vertical CRSs delimited by the plus sign (+).
    /// </param>
