...
{
public:
    GEOMENT_DECLARE_MEMBERS(AcDbAssocBlendSurfaceActionBody);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject explanation. </param>
    ///
    ACDB_PORT explicit AcDbAssocBlendSurfaceActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDB_PORT Adesk::Int16       startEdgeContinuity(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
    ...
    ///
    ACDB_PORT Acad::ErrorStatus  setStartEdgeContinuity (Adesk::Int16 value, const AcString& expression = AcString(), 
    ...
    ///
    ACDB_PORT Adesk::Int16       endEdgeContinuity(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus  setEndEdgeContinuity (Adesk::Int16 value, const AcString& expression = AcString(), 
        const AcString& evaluatorId = AcString()); 
    ...
    ///
    ACDB_PORT double             startEdgeBulge(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
    ...
    ///
    ACDB_PORT double             endEdgeBulge(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
