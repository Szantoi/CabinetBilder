...
{
public:
    GEOMENT_DECLARE_MEMBERS(AcDbAssocFilletSurfaceActionBody);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject explanation. </param>
    ///
    ACDB_PORT explicit AcDbAssocFilletSurfaceActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus setHintPoints(const AcGePoint3d hintPoints[2], const AcGeVector3d& viewDir);
    ...
    ///
    ACDB_PORT double radius(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus getFilletHandleData (AcGePoint3d& pt, 
                                           AcGeVector3d& dir,
