...
public:
    ...
    void              erased(const AcDbObject* dbObj,
    ...
    Acad::ErrorStatus setBlockTableRecordId (int row, 
                                             ...
                                             const AcDbObjectId& blkId, 
                                             bool autoFit);
    ACDBCORE2D_PORT AcString getBlockAttributeValue (int row,
                                             int col,
                                             int nContent,
                                             const AcDbObjectId& attdefId) const;
#define AcDbTabl_Deprecated_ACHAR_Methods
#ifdef AcDbTabl_Deprecated_ACHAR_Methods
...
#ifdef AcDbTabl_Deprecated_ACHAR_Methods
inline Acad::ErrorStatus AcDbTable::getBlockAttributeValue(int row,
                                             int col,
                                             int nContent,
                                             const AcDbObjectId& attdefId,
                                             ACHAR*& value) const
{
    value = nullptr;
    const AcString sRet = this->getBlockAttributeValue(row, col, nContent, attdefId);
    return ::acutNewString(sRet.constPtr(), value);
}
...
inline Acad::ErrorStatus AcDbTable::getBlockAttributeValue(int row,
                                           ...
                                           ACHAR*& value) const
{
    return this->getBlockAttributeValue(row, col, 0, attdefId, value);
}
#endif
