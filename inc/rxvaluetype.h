...
protected:
    ...
    ///
    /// <param name="size">
    /// Size in bytes of the value described by the type. Should be less than 512.
    /// </param>
    ///
...
private:
    ...
    void* m_unused1 = nullptr; //for future use
...
#undef delete
inline void operator delete(void* p, Storage* loc) { ADESK_UNREFED_PARAM(p); ADESK_UNREFED_PARAM(loc); } //Unreferenced parameters
