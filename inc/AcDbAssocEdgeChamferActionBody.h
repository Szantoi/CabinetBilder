...
{
public:
    GEOMENT_DECLARE_MEMBERS(AcDbAssocEdgeChamferActionBody);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject. </param>
    ///
    ACDB_PORT explicit AcDbAssocEdgeChamferActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDB_PORT Acad::ErrorStatus setInput(const AcDbFullSubentPathArray& chamferEdges, const AcDbSubentId& baseFace);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus setBaseDistance(double baseDistance, const AcString& expression = AcString(), 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus setOtherDistance(double otherDistance, const AcString& expression = AcString(), 
        const AcString& evaluatorId = AcString());
    ...
    ///
    ACDB_PORT double baseDistance(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
    ...
    ///
    ACDB_PORT double otherDistance(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
