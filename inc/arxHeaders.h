...
#ifdef _AFXEXT
	#pragma comment (lib ,"acui25.lib")
	#pragma comment (lib ,"adui25.lib")
...
#pragma comment (lib ,"AcFdEval.lib")
	...
	#pragma comment (lib ,"aseapi25.lib")
	#pragma comment (lib ,"asiapi25.lib")
#else
	#pragma comment (lib ,"aseapi25d.lib")
	#pragma comment (lib ,"asiapi25d.lib")
#endif
