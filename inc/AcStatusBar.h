...
typedef void* AcTrayItemClickCallbackData;
typedef void (*AcTrayItemClickCallbackFunc)(UINT mouseButtonMsg /* e.g. WM_LBUTTONDOWN */, UINT controlButtonDownFlags /* e.g MK_CONTROL */, const CPoint &point, AcTrayItemClickCallbackData userData);
