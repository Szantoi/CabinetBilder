...
#define AcDbPlotSttng_Deprecated_ACHAR_Methods
#ifdef AcDbPlotSttng_Deprecated_ACHAR_Methods
    Acad::ErrorStatus
    getPlotSettingsName        (ACHAR *& plotSettingsName) const;
#endif
    ACDBCORE2D_PORT Acad::ErrorStatus
    getPlotSettingsName        (AcString & plotSettingsName) const;
    ...
    // note that this returns a pointer that can become invalidated after calling getLocaleMediaName
    Acad::ErrorStatus  getCanonicalMediaName      (const ACHAR *& mediaName) const;

    /// <summary>
    /// Returns canonical media name of Plot Settings object.
    /// </summary>
    ///
    /// <param name="mediaName">
    /// AcString object to set to canonical media name
    /// </param>
    /// 
    /// <returns>
...
#ifdef AcDbPlotSttng_Deprecated_ACHAR_Methods
inline Acad::ErrorStatus AcDbPlotSettings::getPlotSettingsName(ACHAR *& plotSettingsName) const
{
    return ::acutGetAcStringConvertToAChar(this,
                    &AcDbPlotSettings::getPlotSettingsName, plotSettingsName);
}
#endif
