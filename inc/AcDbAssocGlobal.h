...
public:
    ...
    ACDBCORE2D_PORT AcDbAssocEvaluationCallback() {}

    /// <summary> Virtual destructor. </summary>
    ACDBCORE2D_PORT virtual ~AcDbAssocEvaluationCallback() {}
    ...
    ///
    ACDBCORE2D_PORT virtual AcDbAssocEvaluationMode evaluationMode() const { return kModifyObjectsAssocEvaluationMode; }
    ...
    ///
    ACDBCORE2D_PORT virtual void beginActionEvaluation(AcDbAssocAction* pAction) = 0;
    ...
    /// <param name="pAction"> The action that is being evaluated. </param>
    ///
    ACDBCORE2D_PORT virtual void endActionEvaluation(AcDbAssocAction* pAction) = 0;
    ...
    ///
    ACDBCORE2D_PORT virtual void setActionEvaluationErrorStatus(AcDbAssocAction*    pAction,
    ...
    /// </param>
    ///
    ACDBCORE2D_PORT virtual void endActionEvaluationUsingObject(AcDbAssocAction*    pAction, 
                                                const AcDbObjectId& objectId, 
    ...
    /// </param>
    ///
    ACDBCORE2D_PORT virtual void allDependentActionsMarkedToEvaluate(AcDbAssocNetwork* /*pNetwork*/) {
    }
    ...
    ///
    ACDBCORE2D_PORT virtual AcDbAssocDraggingState draggingState() const { return kNotDraggingAssocDraggingState; }
    ...
    ///
    ACDBCORE2D_PORT virtual bool cancelActionEvaluation() { return false; }
    ...
    ///
    ACDBCORE2D_PORT virtual AcDbEvalContext* getAdditionalData() const { return NULL; }
    ...
    ///
    ACDBCORE2D_PORT virtual AcDbAssocTransformationType getTransformationType() const { return kNotSpecified; }
...
public:
    /// <summary> Default constructor. </summary>
    ACDBCORE2D_PORT AcDbActionsToEvaluateCallback() {}

    /// <summary> Virtual destructor. </summary>
    ACDBCORE2D_PORT virtual ~AcDbActionsToEvaluateCallback() {}
...
public:
    /// <summary> Default constructor. </summary>
    ACDBCORE2D_PORT AcDbSubentGeometry() : mSubentType(AcDb::kNullSubentType), mpCurve(NULL) {}
    ...
    ///
    ACDBCORE2D_PORT AcDbSubentGeometry(AcGeCurve3d* pCurve)
    ...
    ///
    ACDBCORE2D_PORT AcDb::SubentType type() const { return mSubentType; }

    /// <summary> Returns coordinates of the vertex subentity. </summary>
    /// <returns> Coordinates of the vertex subentity. </returns>
    ///
    ACDBCORE2D_PORT AcGePoint3d point() const { return mPoint; }
    ...
    ///
    ACDBCORE2D_PORT AcGeCurve3d* curve() const { return mpCurve; }
