...
public:
    ...
    //
#define AcDbDict_Deprecated_ACHAR_Methods
#ifdef AcDbDict_Deprecated_ACHAR_Methods
    ...
    // Remove entries.
    //
    Acad::ErrorStatus remove(const ACHAR *  key);   // inline in this header
    ACDBCORE2D_PORT
    ...
    // AcDbObject Protocol
    //
    Acad::ErrorStatus subErase     (Adesk::Boolean pErasing
