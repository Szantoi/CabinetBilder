...
public: 
    ...
    ///
    ACDBCORE2D_PORT AcDbAssocActionParam(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus transformConstantGeometry(const AcGeMatrix3d& transform);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getDependencies(bool readDependenciesWanted, 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus getCompoundObjectIds(bool                           readDependenciesWanted, 
                                           bool                           writeDependenciesWanted,
    ...
    ///
    ACDBCORE2D_PORT virtual void collectPersSubentNamingDataOverride(AcDbPersStepIdArray&   stepIds, 
    ...
    /// <remarks> This method is currently for internal use only. </remarks>
    ///
    ACDBCORE2D_PORT virtual void clonePersSubentNamingDataOverride(AcDbAssocPersSubentManagerCloner* pCloner);
};
