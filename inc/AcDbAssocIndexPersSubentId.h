...
public:
    ...
    ACDBCORE2D_PORT explicit AcDbAssocIndexPersSubentId(AcDb::SubentType subentType = AcDb::kNullSubentType, unsigned int index = 0);
    ...
    ACDBCORE2D_PORT AcDb::SubentType subentType(const AcDbEntity*, AcDbDatabase*) const override { return mSubentType; }

    ACDBCORE2D_PORT bool isNull() const override { return mSubentType == AcDb::kNullSubentType; }
    ...
    ACDBCORE2D_PORT unsigned int index() const { return mIndex; }

    ACDBCORE2D_PORT void setSubentType(AcDb::SubentType subentType) { mSubentType = subentType; }
    ACDBCORE2D_PORT void setIndex     (unsigned int newIndex)       { mIndex      = newIndex;   }
...
public:
    ...
    ACDBCORE2D_PORT explicit AcDbAssocExternalIndexPersSubentId(AcDb::SubentType subentType = AcDb::kNullSubentType, unsigned int index = 0) 
...
public:
    ...
    ACDBCORE2D_PORT AcDbAssocObjectAndIndexPersSubentId() {}
    ACDBCORE2D_PORT AcDbAssocObjectAndIndexPersSubentId(const AcDbObjectId& objId, AcDb::SubentType subentType, unsigned int index);

    ACDBCORE2D_PORT bool operator ==(const AcDbAssocObjectAndIndexPersSubentId& other) const;
    ACDBCORE2D_PORT bool operator  <(const AcDbAssocObjectAndIndexPersSubentId& other) const;

    ACDBCORE2D_PORT AcDbObjectId objectId() const { return mObjectId; }

    ACDBCORE2D_PORT void setObjectId(const AcDbObjectId& objId) { mObjectId = objId; }
