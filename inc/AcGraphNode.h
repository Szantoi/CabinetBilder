...
class  AcGraphNode : public AcRxObject, 
...
public:
    ...
    /// <returns> Acad::ErrorStatus </returns>
    ACDBCORE2D_PORT virtual Acad::ErrorStatus nodeToBeMovedNotification(AcGraph *pGraph, AcArray<AcGraphNode *> & otherNodesToMove);
