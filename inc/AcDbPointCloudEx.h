...
public:
    ...
    /// Returns Acad::eOk if successful.
    /// </returns>
    Acad::ErrorStatus       subSwapIdWith(AcDbObjectId otherId,
...
public:
    ...
    /// <summary>
    /// Return the pointer to read only ReCap object which allow direct access to RCProject object
    /// RCProject* object returned should NOT be explicitly deleted by the caller
    /// RCProject* object will become invalid when the point cloud is detached.
    /// </summary>
    /// <returns>
    /// Returns RCProject pointer or nullptr if point cloud is already detached or invalid.
    /// </returns>
