...
{
public:
    GEOMENT_DECLARE_MEMBERS(AcDbAssocSweptSurfaceActionBody);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject explanation. </param>
    ///
    ACDB_PORT explicit AcDbAssocSweptSurfaceActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDB_PORT Acad::ErrorStatus setScaleFactor(double scale, const AcString& expression = AcString(), 
    ...
    ///
    ACDB_PORT double scaleFactor(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus setAlignAngle(double angle, const AcString& expression = AcString(), 
        const AcString& evaluatorId = AcString());
    ...
    ///
    ACDB_PORT double alignAngle(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus setTwistAngle(double angle, const AcString& expression = AcString(), 
        const AcString& evaluatorId = AcString());
    ...
    ///
    ACDB_PORT double twistAngle(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
