...
public:
    ...
    GE_DLLEXPIMPORT AcGeEntity2d&    operator =  (AcGeEntity2d&& entity) noexcept;
...
protected:
    ...
    GE_DLLEXPIMPORT AcGeEntity2d (AcGeEntity2d&&) noexcept;
    ...
    GE_DLLEXPIMPORT void copyConstructor (const AcGeEntity2d&);
    GE_DLLEXPIMPORT void moveConstructor(AcGeEntity2d&&) noexcept;
};
