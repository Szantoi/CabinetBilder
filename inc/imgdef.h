...
public:
    ...
    /// <sumary>
    /// This function checks if the image should be loaded.
    /// </sumary>
    /// <returns>Returns Adesk::kTrue if it should be loaded.</returns>
    virtual Adesk::Boolean      shouldLoad() const;
    ...
    /// <sumary>
    /// This function returns the name of the dictionary in the Named Object Dictionary that contains
    /// all image definitions
    /// </sumary>
    /// <returns>Returns a constant string value</returns>

    static constexpr const ACHAR* dictionaryName() {
        return L"ACAD_IMAGE_DICT";
    }
