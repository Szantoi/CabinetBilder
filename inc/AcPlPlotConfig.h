...
#include "AcPl.h"
//#include "heidi/charset.h"
//#include "toolkit/plotcfg/kit.h"
//#include "toolkit/plotcfg/smartptr.h"
#include "acarray.h"
#include "gepnt2d.h"
#include "geblok2d.h"
#include "dblayout.h"
...
public:
    ...
    ACPL_PORT AcPlPlotConfigImp& impObj() const; // internal use only

    // internal use only
    ACPL_PORT bool matchMediaSize(double page_x, double page_y,
...
private:
    AcPlPlotConfig();
public:
    AcPlPlotConfig(const ACHAR* pDevName,
