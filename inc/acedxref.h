...
ACCORE_PORT Acad::ErrorStatus acedXrefCreateBlockname(const ACHAR* XrefPathname,
                                                      AcString & XrefBlockname);
#define AcEdXref_Deprecated_ACHAR_Funcs
#ifdef AcEdXref_Deprecated_ACHAR_Funcs
inline Acad::ErrorStatus acedXrefCreateBlockname(const ACHAR* XrefPathname,
                                                 ACHAR * & XrefBlockname)
{
    AcString sRet;
    const Acad::ErrorStatus es = ::acedXrefCreateBlockname(XrefPathname, sRet);
    ::acutNewString(sRet.constPtr(), XrefBlockname);
    return es;
}
#endif
