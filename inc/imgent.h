...
#ifndef ISM_OBJ
// Use kEpsilon defined in AcDbRasterImage
#ifndef _ADESK_CROSS_PLATFORM_
ADESK_DEPRECATED const double kEpsilon = 1.0e-7;
#endif
#endif
...
public:
    ...
    Acad::ErrorStatus   subSwapIdWith(
    ...
    //
    AcGiSentScanLines*  getScanLines(
                            const AcGiRequestScanLines& req
                        ) const override;
    Adesk::Boolean      freeScanLines(
...
protected:
    ...
    Acad::ErrorStatus   subGetTransformedCopy(
