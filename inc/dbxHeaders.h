...
//
#pragma warning (disable: 4312)         // conversion of 32-bit int to 64-bit pointer

#ifdef _MANAGED
#pragma warning( disable : 4561 )       // __fastcall incompatible with /clr
#endif
...
#pragma comment (lib ,"acge25.lib")
#pragma comment (lib ,"acISMobj25.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#pragma comment (lib ,"ac1st25.lib") 
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex25.lib")
	#pragma comment (lib ,"acbr25.lib")
#endif // _BREP_SUPPORT_
#else // AC_FULL_DEBUG
#pragma comment (lib ,"rxapi.lib")
#pragma comment (lib ,"acdb25d.lib")
#pragma comment (lib ,"acge25d.lib")
#pragma comment (lib ,"acISMobj25d.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#pragma comment (lib ,"ac1st25d.lib") 
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex25d.lib")
	#pragma comment (lib ,"acbr25d.lib")
#endif // _BREP_SUPPORT_
#endif // AC_FULL_DEBUG

#ifdef _HLR_SUPPORT_
	#pragma comment (lib ,"AsdkHlrApi25.lib")
#endif
...
// Warning: the "abb" files tend to pollute the global namespace with simple names,
// which could cause conflicts with clients' use of other frameworks.  Normally they
// are not intended for use in other API headers
//
#include "acdbabb.h"
#include "gegblabb.h"

// Note: there are no useful abbreviations in adeskabb.h anymore, since its 9 typedefs
// and 2 constants all have equivalents in standard C++ now.  New code should use the
// C++ standard definitions instead of adeskabb.h's
//
#include "adeskabb.h"
