...
public:
    ...
    ///
    ACDBCORE2D_PORT AcDbAssocArrayRectangularParameters(double columnSpacing = 1, double rowSpacing = 1, 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT ~AcDbAssocArrayRectangularParameters(void);
    ...
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus setColumnCount(int nColumns, const AcString& expression = AcString(), 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus setColumnSpacing(double offset, const AcString& expression = AcString(), 
        const AcString& evaluatorId = AcString(), AcString& errorMessage = dummyString());
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus setAxesAngle(double axesAngle, const AcString& expression = AcString(), 
        const AcString& evaluatorId = AcString(), AcString& errorMessage = dummyString());
...
protected:
    ...
    ACDBCORE2D_PORT explicit AcDbAssocArrayRectangularParameters(AcDbImpAssocArrayRectangularParameters* pSelf);
};
