...
public:
    ...
    /// </returns>
    ACDB_PORT Acad::ErrorStatus  convertProfile ( bool explodeMultiFaceRegions, bool convertSurfaceToEdges,
...
public:
    ...
    /// </returns>
    ACDB_PORT Adesk::Int16  continuity () const;
    ...
    /// G0, G1, or G2. 
    /// </param>
    ACDB_PORT void          setContinuity ( Adesk::Int16 value );
