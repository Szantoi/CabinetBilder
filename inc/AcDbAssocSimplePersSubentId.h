...
/// </summary>
///
class  AcDbAssocSimplePersSubentId : public AcDbAssocPersSubentId
{
public:
	ACRX_DECLARE_MEMBERS_EXPIMP(AcDbAssocSimplePersSubentId, ACDBCORE2D_PORT);

    /// <summary>
    /// Constructor. Just keeps the given AcDbSubentId.
    /// </summary>
    ACDBCORE2D_PORT explicit AcDbAssocSimplePersSubentId(AcDbSubentId subentId = kNullSubentId) : mSubentId(subentId) {}
    ...
    ///
    ACDBCORE2D_PORT virtual AcDbSubentId subentId(const AcDbEntity*) const { return mSubentId; }
    ...
    ///
    ACDBCORE2D_PORT void setSubentId(const AcDbSubentId& newSubentId) { mSubentId = newSubentId; }
