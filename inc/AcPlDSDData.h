...
public:
    ...
    /// <summary>
    /// Determines if the publish process attempts to initialize uninitialized layouts
    /// </summary>
    /// <returns>
    /// Value of initialize layouts
    /// </returns>
    ...
    /// Determines if the publish process attempts to initialize uninitialized layouts
    /// </summary>
    /// <param name="initLayouts">New value for initialize layouts</param>
