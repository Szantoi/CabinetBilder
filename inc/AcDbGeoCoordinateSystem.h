...
class AcDbGeoVerticalCoordinateSystem;
...
public:
    ...
    /// <summary> Returns all coordinate system ids in a given array. </summary>
    /// 
    /// <param name="ids">
    /// Input/output array of coordinate system ids.
    /// </param>
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    virtual Acad::ErrorStatus          getCoordinateSystemIds(AcArray<AcString>& ids) const = 0;

    /// <summary> Returns number of vertical coordinate systems belonging to this category. </summary>
    /// 
    /// <param name="num">
    /// Input/output integer.
    /// </param>
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    virtual Acad::ErrorStatus          getNumOfVerticalCoordinateSystem(int& num) const = 0;

    /// <summary> Returns the vertical coordinate system at a given index. </summary>
    /// 
    /// <param name="index">
    /// Input integer.
    /// </param>
    /// <param name="pCoordSys">
    /// Input/output pointer to AcDbGeoVerticalCoordinateSystem object.
    /// Caller is responsible for deleting the returned object after use.
    /// </param>
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    virtual Acad::ErrorStatus          getVerticalCoordinateSystemAt(int index, AcDbGeoVerticalCoordinateSystem*& pCoordSys) const = 0;

    /// <summary> Returns all vertical coordinate system ids in a given array. </summary>
    /// 
    /// <param name="ids">
    /// Input/output array of vertical coordinate system ids.
    /// </param>
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    virtual Acad::ErrorStatus          getVerticalCoordinateSystemIds(AcArray<AcString>& ids) const = 0;
...
public:
    ...
    /// <summary>
    /// brief Defines enums used to indicate the status of a coordinate reference system.
    /// </summary>
    ///
    enum StatusType
    {
        /// <summary>brief Specifies that the coordinate system is out of date. </summary>
        kStatusTypeOutOfDate = 1,
        /// <summary> brief Specifies that the coordinate system is up to date. </summary>
        kStatusTypeUpToDate = 2,
        /// <summary> brief Specifies that the coordinate system is user defined. </summary>
    ...
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    virtual Acad::ErrorStatus getDatumId(AcString& datumId) const = 0;
    ...
    /// 
    /// <param name="status">
    /// Input/output AcDbGeoCoordinateSystem::StatusType.
    /// </param>
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    virtual Acad::ErrorStatus getStatus(AcDbGeoCoordinateSystem::StatusType& status) const = 0;
...
/// <summary>
/// the AcDbGeoVerticalCoordinateSystem class represents a vertical coordinate reference system (vertical CRS) definition. 
/// A vertical CRS is also being referred to as a spatial reference system (SRS). 
/// </summary>
///
class AcDbGeoVerticalCoordinateSystem
{
public:
    /// <summary>
    /// brief Defines enums used to indicate the type of a vertical coordinate reference system.
    /// </summary>
    ///
    enum Type
    {
        ...
        /// <summary> brief Specifies that the coordinate system is ellipsoidal. </summary>
        kTypeEllipsoidal = 1,
        /// <summary> brief Specifies that the coordinate system is geoid model derived. </summary>
        kTypeGeoidModelDerived = 2
    };

    /// <summary>
    /// brief Defines enums used to indicate the axis direction of a vertical coordinate reference system.
    /// </summary>
    ///
    enum AxisDirection
    {
        /// <summary> brief Specifies that the axis direction is not set. </summary>
        kAxisDirectionUnknown = 0,

        /// <summary> brief Specifies that the positive direction of the axis is up. </summary>
        kAxisDirectionUp = 1,
        /// <summary> brief Specifies that the positive direction of the axis is down. </summary>
    ...
    /// virtual destructor
    /// </summary>
    virtual ~AcDbGeoVerticalCoordinateSystem() {};

    /// <summary> 
    /// Get this vertical CRS's identifier string, which is also being referred to as a (coordinate system) code.
    /// The id returned always belongs to the ADSK namespace and is never prefixed.
    /// </summary>
    /// 
    /// <param name="coordSysId">
    ...
    /// 
    /// <param name="type">
    /// Input/output AcDbGeoVerticalCoordinateSystem::Type.
    /// </param>
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    virtual Acad::ErrorStatus getType(AcDbGeoVerticalCoordinateSystem::Type& type) const = 0;
    ...
    /// 
    /// <param name="unit">
    /// Input/output AcDbGeoVerticalCoordinateSystem::AxisDirection.
    /// </param>
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    virtual Acad::ErrorStatus getAxisDirection(AcDbGeoVerticalCoordinateSystem::AxisDirection& direction) const = 0;
    ...
    /// <summary> 
    /// Gets a factor, that the length units of this vertical CRS instance must be
    /// multiplied with to calculate the equivalent in meters.
    /// </summary>
    /// 
    /// <param name="unitScale">
    ...
    /// If no such vertical CRS definition exists but the input string contains enough information(i.e. WKT or XML) 
    /// for constructing a temporary AcDbGeoVerticalCoordinateSystem instance, this is being returned instead.
    /// </summary>
    /// <param name="coordSysIdOrFullDef">
    /// The ID or the (proprietary) XML representation of the vertical CRS definition to load. The XML must contain CRS. The WKT is not supported yet.
    /// Valid examples are:
    ///    - EGM2008_height > Autodesk identifier (default)
    /// </param>
    /// <param name="pCoordSys">
    /// Input/output pointer to AcDbGeoVerticalCoordinateSystem object.
    /// Caller is responsible for deleting the returned object after use.
    ...
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus create(const AcString& coordSysIdOrFullDef,
        AcDbGeoVerticalCoordinateSystem*& pCoordSys);

    /// <summary> 
    /// Instantiates a new AcDbGeoVerticalCoordinateSystem object for every existing, 
    /// persistent vertical CRS definition from the specified catalog.
    /// </summary>
    /// 
    /// <param name="allCoordSys">
    /// Input/output array of AcDbGeoVerticalCoordinateSystem objects.
    /// Caller is responsible for deleting the returned AcDbGeoVerticalCoordinateSystem
    /// objects after use.
    /// </param>
    /// <param name="pCategory">
    /// Input category.
    /// All existing and persistent vertical CRS definitions are returned when pGategoery
    /// is NULL.
    /// </param>
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus createAll(AcArray<AcDbGeoVerticalCoordinateSystem*>& allCoordSys,
        const AcDbGeoCoordinateSystemCategory* pCategory = NULL);
};
...
/// </summary>
///
class AcDbGeoCompoundCoordinateSystem
{
public:
    ...
    /// virtual destructor
    /// </summary>
    virtual ~AcDbGeoCompoundCoordinateSystem() {};
    ...
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    virtual Acad::ErrorStatus getGeodeticCoordinateSystem(AcDbGeoCoordinateSystem*& pCoordSys) const = 0;
    ...
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    virtual Acad::ErrorStatus getVerticalCoordinateSystem(AcDbGeoVerticalCoordinateSystem*& pCoordSys) const = 0;
    ...
    /// If no such CRS definitions exist but the input string contains enough information(i.e. WKT or XML) 
    /// for constructing a temporary AcDbGeoCompoundCoordinateSystem instance, this is being returned instead.
    /// </summary>
    /// <param name="coordSysIdOrFullDef">
    /// The ID or the (proprietary) XML representation of the compound CRS definition to load. 
    /// The XML must contain a geodetic CRS, and the vertical CRS is optional. The ID is either only a geodetic CRS or contains geodetic and vertical CRSs delimited by the plus sign (+). The WKT is not supported yet.
    /// If the vertical CRS is provided, it must be a valid value, or the creation will fail.
    /// Valid examples are:
    ///    - LL84+EGM2008_height
    ///    - LL84
    /// </param>
    /// <param name="pCoordSys">
    /// Input/output pointer to AcDbGeoCompoundCoordinateSystem object.
    /// Caller is responsible for deleting the returned object after use.
    /// </param>
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    ...
    /// </summary>
    /// <param name="coordSysId">
    /// The ID of the geodetic CRS definition to verify. 
    /// Valid examples are:
    ///    - LL84
    /// </param>
    /// <param name="verticalCoordSysId">
    /// The ID of the vertical CRS definition to verify. 
    /// Valid examples are:
    ///    - EGM2008_height
    /// </param>
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus verify(const AcString& coordSysId, const AcString& verticalCoordSysId);
};
