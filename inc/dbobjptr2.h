...
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC=ACDB_CLASS::desc> inline Acad::ErrorStatus
...
accessAcDbObjectForRead<AcDbObject, nullptr>(AcDbObject*& pObj,
    AcDbObjectId id,
    bool& bWasOpened,
    bool bOpenErased)
{
...
template<class, getClassDescFuncType> class AcDbSmartObjectPointer;
...
public:
                    ...
                    bool bOpenErased)
    {
        ...
        if (Acad::eNotOpenForRead == mEs) {
            mEs = accessAcDbObjectForRead<ACDB_CLASS, ACDB_GET_CLASS_DESC>(pObj,
                                          id,
                                          mbWasOpened,
                                          bOpenErased);
...
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::AcDbSmartObjectPointer()
    : mReadable(),
      mWritable()
{
...
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline Acad::ErrorStatus
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::open(
    AcDbObjectId   objId,
    AcDb::OpenMode mode,
    bool           openErased,
    bool           openOnLockedLayer)
...
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline const ACDB_CLASS *
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::object() const
{
...
// allowed to.
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline ACDB_CLASS *
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::object()
{
...
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline const ACDB_CLASS *
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::operator->() const
{
    return object();
}

template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline ACDB_CLASS *
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::operator->()
{
    return object();
}

template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::operator const ACDB_CLASS*() const
{
    return object();
}
...
#if DBOBJPTR_EXPOSE_PTR_REF
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::operator ACDB_CLASS* &()
{
...
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline Acad::ErrorStatus
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::openStatus() const
{
...
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline Acad::ErrorStatus
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::acquire(ACDB_CLASS *& pObjToAcquire)
{
...
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline Acad::ErrorStatus
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::release(ACDB_CLASS *& pReleasedObj)
{
...
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline Acad::ErrorStatus
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::close()
{
    closeInternal();
    return Acad::eOk;
}
...
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline Acad::ErrorStatus
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::create()
{
...
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline Acad::ErrorStatus
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::closeInternal()
{
...
template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::AcDbSmartObjectPointer(ACDB_CLASS *pObject)
{
    acquire(pObject);
}

template<class ACDB_CLASS, getClassDescFuncType ACDB_GET_CLASS_DESC> inline void
AcDbSmartObjectPointer<ACDB_CLASS, ACDB_GET_CLASS_DESC>::operator=(ACDB_CLASS *pObject)
{
    acquire(pObject);
}
