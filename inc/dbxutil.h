...
#include "dbidar.h"
#include "dbid.h"
#include "gegbl.h"              // AcGeContext
#include "getol.h"              // AcGeTol
#include "acutmem.h"
...
ACDBCORE2D_PORT Acad::ErrorStatus acdbGetProxyInfo(AcDbObject *pObj, AcString & dxfName,
                                   AcString & className, AcString & appName);
...
ACDBCORE2D_PORT AcDbObjectId  acdbGetDimStyleId(AcDbDatabase* pDb, const ACHAR* styleName, const ACHAR* lockName);
ACDBCORE2D_PORT AcDbObjectId  acdbGetDynDimStyleId( AcDbDatabase* pDb = NULL );
...
/// <summary>
/// This function can be used to determine if the tight extents calculations are
/// enabled for AcDb3dSolid, AcDbSurface, and AcDbRegion entities.
/// </summary>
///
/// <returns>
/// true if the tight extents calculations are enabled, or
/// false if the tight extents calculations are not enabled.
/// </returns>
ACDB_PORT bool acdbIsEnabledTightExtents();

/// <summary>
/// This function can be used to enable the tight extents calculations before using
/// getGeomExtents on the AcDb3dSolid, AcDbSurface, and AcDbRegion entities. 
/// </summary>
///
/// <param name="bEnable">
/// When bEnable is set to true, the tight extents calculations will be enabled for 
/// getGeomExtents on the AcDb3dSolid, AcDbSurface, and AcDbRegion entities. 
/// </param>
///
/// <remarks>
/// The caller should call acdbSetEnableTightExtents with false after 
/// obtaining the extents from getGeomExtents, in order to restore the 
/// default behavior.
/// </remarks>
ACDB_PORT void acdbSetEnableTightExtents(bool bEnable);
