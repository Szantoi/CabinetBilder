...
{
public:     
    ACDB_DECLARE_MEMBERS(AcDbAssocVariable);


    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject. </param>
    ///
    ACDBCORE2D_PORT explicit AcDbAssocVariable(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDBCORE2D_PORT const AcString& expression() const;

    ACDBCORE2D_PORT const AcString& expression(bool convertSymbolNamesFromCanonicalForm) const;

    /// <summary> Returns the evaluated and cached value of the variable. </summary>
    /// <returns> The value of the variable. </returns>
    ///
    ACDBCORE2D_PORT const AcDbEvalVariant& value() const;
    ...
    ///
    ACDBCORE2D_PORT const AcString& description() const;
    ...
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus setName(const AcString& newName, bool updateReferencingExpressions);
    ...
    ///
    ACDBCORE2D_PORT bool isAnonymous() const;
...
{
public:
    ACDBCORE2D_PORT AcDbAssocVariableCallback() {}
    ACDBCORE2D_PORT virtual ~AcDbAssocVariableCallback() {}
    ...
    ///</returns>
    ///
    ACDBCORE2D_PORT virtual bool canBeErased(const AcDbAssocVariable* pVariable) = 0;
    ...
    /// </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus validateNameAndExpression(const AcDbAssocVariable* pVariable,
