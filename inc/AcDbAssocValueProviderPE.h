...
/// </para> </summary>
///
class  AcDbAssocValueProviderPE : public AcRxObject
{
public:
	ACRX_DECLARE_MEMBERS_EXPIMP(AcDbAssocValueProviderPE, ACDBCORE2D_PORT);
    ...
    /// </returns>
    ///
    ACDBCORE2D_PORT virtual bool canGetValue(const AcDbObject* pObject, const AcString& valueName) { 
    ...
    /// </returns>
    ///
    ACDBCORE2D_PORT virtual bool canSetValue(const AcDbObject* pObject, const AcString& valueName) { 
        ADESK_UNREFED_PARAM(pObject);
        ADESK_UNREFED_PARAM(valueName);
        return false;
    }
    ...
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getValue(const AcDbObject* pObject, 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus setValue(AcDbObject*            pObject, 
                                       const AcString&        valueName, 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus getObjectValue(const AcDbObjectId&, const AcString& valueName, AcDbEvalVariant& value);
    ACDBCORE2D_PORT static Acad::ErrorStatus setObjectValue(const AcDbObjectId&, const AcString& valueName, const AcDbEvalVariant& value);
