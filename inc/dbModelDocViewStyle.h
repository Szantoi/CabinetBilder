...
class  ADESK_NO_VTABLE AcDbModelDocViewStyle : public AcDbObject
{
protected:
    /// <summary>
    /// Default constructor.
...
public:
    ACDB_DECLARE_MEMBERS_ABSTRACT(AcDbModelDocViewStyle);
...
#define AcDbModelDocViewStyle_Deprecated_ACHAR_Methods
#ifdef AcDbModelDocViewStyle_Deprecated_ACHAR_Methods
    /// <summary>
    ...
    /// Return Acad::eOk if successful.
    /// </returns>
    ACDBCORE2D_PORT Acad::ErrorStatus postViewStyleToDb (AcDbDatabase* pDb, const ACHAR* styleName, AcDbObjectId &viewStyleId);
    ...
    /// on bounding box.
    /// </returns>
    ACDBCORE2D_PORT static AcGePoint3d calculateViewLabelPosition  (AcGeVector2d &offsetVector,
    ...
    /// on bounding box.
    /// </returns>
    ACDBCORE2D_PORT static AcGeVector2d setViewLabelPosition   (AcDbMText *pMText,
                                                AcDbModelDocViewStyle::AttachmentPoint attachment,
                                                double offset,
                                                const AcGePoint3d &minPt,
                                                const AcGePoint3d &maxPt);
    ...
    /// on bounding box.
    /// </returns>
    ACDBCORE2D_PORT static AcGeVector2d updateViewLabelPosition(AcDbMText *pMText,
                                                AcDbModelDocViewStyle::AttachmentPoint &attachment,
                                                const AcGePoint3d &minPt,
                                                const AcGePoint3d &maxPt);
