...
typedef Acad::ErrorStatus (*ACJSCORESTUB_DEFUN_PROC)(const ACHAR* name, AcJsFunctionPtr funcAddr, Adesk::Int32 funcFlags);
...
/// </returns>
extern "C" ACJSCORESTUB_PORT Acad::ErrorStatus acjsDefun    (const ACHAR* name, AcJsFunctionPtr funcAddr, Adesk::Int32 funcFlags = 0);
...
/// </remarks>
extern "C" ACJSCORESTUB_PORT Acad::ErrorStatus acjsInvokeAsync  (const ACHAR* name, 
                                                                 const ACHAR* jsonArgs);
