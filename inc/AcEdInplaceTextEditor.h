...
public:
    ...
    ///<summary> 
    /// Set Text editor entity's layer.
    /// If the layer name doesn't exist, then a new layer with the given name will be created from zero layer.
    ///</summary>
    /// <param name="layername">The layer name to set.</param>
    /// <returns>
    /// Returns Acad::eOk if the operation succeeds.
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
