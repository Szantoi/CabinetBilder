...
public:
    ...
    ACAD_PORT const AcGePoint3d&                       lastPoint() const;
          // rawPoint: what the point is as tracked by the cursor position before
          // subsequent filtering, or as entered in via alternate means, which is
          // subject to far less filtering. valid if pointComputed above is TRUE
          //
...
class AcEdInputPointFilter : public AcRxObject
{
  ...
  public:
    ...
    //
    // This overload is no longer called. It's only declared here so we can mark it
    // final and prevent clients from declaring it.  Will be removed in a future release
    //
    virtual Acad::ErrorStatus processInputPoint(
          bool& /*changedPoint*/, AcGePoint3d& /*newPoint*/, bool& /*displayOsnapGlyph*/,
          bool& /*changedTooltipStr*/, ACHAR*& /*newTooltipString*/, bool& /*retry*/,
          AcGiViewportDraw* /*drawContext*/, AcApDocument* /*document*/, bool /*pointComputed*/,
          ...
          const ACHAR* /*tooltipString*/) final
    {
        return Acad::eOk;
    }
    ...
    virtual AcEdInputPointFilter* revokeInputFilter
        (AcEdInputPointFilter* /*revokedFilter*/)
    {
        return this;
    }
...
class AcEdInputPointMonitor : public AcRxObject
{
    ...
    virtual Acad::ErrorStatus monitorInputPoint(
          bool& /*appendToTooltipStr*/, ACHAR*& /*additionalTooltipString*/,
          AcGiViewportDraw* /*drawContext*/, AcApDocument* /*document*/,
          bool /*pointComputed*/, int /*history*/, const AcGePoint3d& /*lastPoint*/,
          const AcGePoint3d& /*rawPoint*/, const AcGePoint3d& /*grippedPoint*/,
          const AcGePoint3d& /*cartesianSnappedPoint*/, const AcGePoint3d& /*osnappedPoint*/,
          AcDb::OsnapMask /*osnapMask*/, const AcArray<AcDbCustomOsnapMode*>& /*customOsnapModes*/,
          AcDb::OsnapMask /*osnapOverrides*/,
          const AcArray<AcDbCustomOsnapMode*>& /*customOsnapOverrides*/,
...
// keyword.
//
// And finally, note that many endGetXXX() methods pass non-const references
// to the return value.  Callers are not expected to modify these values and
// the args will change to const references in the future.
...
public:
    ...
    virtual void beginGetColor(const AcCmColor * /*dfault*/, // NULL implies no default
                               const ACHAR* /*promptString*/,
                               int   /*initGetFlags*/,
                               const ACHAR* /*pKeywords*/) { }

    virtual void endGetColor(Acad::PromptStatus /*returnStatus*/,
                             const AcCmColor & /*retValue*/,
                             const ACHAR*& /*pKeyword*/) { }

  private:
    // These overloads are no longer used.  Please use the ones with AcCmColor arg
    virtual void beginGetColor(const int* /*dfault*/, // NULL implies no default
                               const ACHAR* /*promptString*/,
                               int   /*initGetFlags*/,
                               const ACHAR* /*pKeywords*/) final { }

    virtual void endGetColor(Acad::PromptStatus /*returnStatus*/,
                             int& /*retValue*/,
                             const ACHAR*& /*pKeyword*/) final { }
