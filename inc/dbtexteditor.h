...
public:
    ...
    /// selection.
    ///</summary>
    /// <param name="pStartLocation">The output AcDbTextEditorLocation pointer for the start of the selection</param>
    /// <param name="pEndLocation">The output AcDbTextEditorLocation pointer for the end of the selection</param>
    /// <returns>
    /// Returns Acad::eOk if the operation succeeds.
    /// Returns Acad::eInvalidInput if the operation fails.
    /// Returns Acad::eNotApplicable if the selection is empty.
    /// </returns>
    ACDBCORE2D_PORT Acad::ErrorStatus getLocations(AcDbTextEditorLocation*& pStartLocation, AcDbTextEditorLocation*& pEndLocation) const;
