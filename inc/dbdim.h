...
#include "dbmain.h"
#include "dbmtext.h"    // AcDbMText::AttachmentPoint
...
#define AcDbDim_Deprecated_ACHAR_Methods
#ifdef AcDbDim_Deprecated_ACHAR_Methods
...
// deprecated
#ifdef AcDbDim_Deprecated_ACHAR_Methods
inline ACHAR * AcDbDimension::dimensionText() const
{
    return ::acutGetAcStringConvertToAChar(this, &AcDbDimension::dimensionText);
}
#endif
