...
#include "rxboiler.h"
#include "AcCmColor.h" // AcCmColor
#include "dbObject.h"
#include "AcUniqueString.h"
...
private:
    ...
    Adesk::UInt32 m_nImageWidth = 0;
    Adesk::UInt32 m_nImageHeight = 0;
};
...
public:
    ...
    ACDBCORE2D_PORT AcGiVariant(void);
    ACDBCORE2D_PORT ~AcGiVariant(void);
...
#define AcGi_Deprecated_ACHAR_Methods
#ifdef AcGi_Deprecated_ACHAR_Methods
...
public:
    ...
    virtual bool supportsCurveTrait() const { return false; }
    ...
    ///////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////
    // These APIs are provided for internal use only, do not use them
...
{
public:
    ACRX_DECLARE_MEMBERS_EXPIMP(AcGiContext2, ACDBCORE2D_PORT);
...
public:
    ...
    enum DrawFlags
    {
        ...
        /// <summary>
        /// This item hints graphic render system the geometry data is world space.
        /// E.g, for vertex positions, they have multiplied the model transform to world space.
        /// </summary>
        kDrawIsInWCS                     = 4096,

        /// <summary>
        /// Draw raster images without image frame
        /// </summary>
...
inline void
AcGiSubEntityTraits::setLineWeight(const AcDb::LineWeight lw, const char /*lweight_index*/)
{
    setLineWeight(lw);
}
...
public:
    ...
    ACDBCORE2D_PORT AcGiPolyline(Adesk::UInt32 nbPoints, AcGePoint3d* pVertexList, AcGeVector3d* pNormal = NULL, Adesk::LongPtr lBaseSubEntMarker = -1);
    ACDBCORE2D_PORT ~AcGiPolyline();

    enum LinetypeGeneration { kPerSegment, kEndToEnd };

    ACDBCORE2D_PORT virtual Adesk::UInt32 points() const;
    ...
    ACDBCORE2D_PORT virtual Adesk::LongPtr baseSubEntMarker() const;
    ACDBCORE2D_PORT virtual const Adesk::LongPtr* subEntMarkerList() const;
    ...
    ACDBCORE2D_PORT virtual bool getWidthsAt(unsigned int idx, double& startWidth, double& endWidth) const;

    ACDBCORE2D_PORT virtual void setVertexList(Adesk::UInt32 nbPoints, const AcGePoint3d* pVertexList);
    ...
    ACDBCORE2D_PORT virtual void setBaseSubEntMarker(Adesk::LongPtr lBaseSubEntMarker);
    ACDBCORE2D_PORT virtual void setSubEntMarkerList(const Adesk::LongPtr* pSubEntMarkerList);
...
public:
    ...
    virtual Adesk::Boolean curve(const AcGeCurve3d* /*pCurve*/) const { return Adesk::kFalse; };
};
...
public:
    ...
    rasterImageDcUsingRawPointer(const AcGePoint3d & origin,
                                  const AcGeVector3d & u,
                                  const AcGeVector3d & v,
                                  const AcGeMatrix2d & pixelToDc,
                                  AcDbRasterImage* pRasterImage,
                                  AcGiImageOrg imageOrg,
                                  Adesk::UInt32 imageWidth,
                                  Adesk::UInt32 imageHeight,
                                  Adesk::Int16 imageColorDepth,
                                  ...
                                  const AcGeMatrix2d& unrotatedPixelToDc,
                                  const Adesk::UInt32 unrotatedImageWidth,
                                  const Adesk::UInt32 unrotatedImageHeight) const { return Adesk::kFalse; };
};
...
public:
    ...
    ACDBCORE2D_PORT virtual void            setSelectionMarkers(const Adesk::LongPtr* pSelectionMarkers);
    ACDBCORE2D_PORT virtual void            setVisibility(const Adesk::UInt8* pVisibility);
    ...
    ACDBCORE2D_PORT virtual Adesk::LongPtr* selectionMarkers() const;
    ACDBCORE2D_PORT virtual Adesk::UInt8*   visibility() const;
};
...
public:
    ...
    ACDBCORE2D_PORT virtual void            setVisibility(const Adesk::UInt8* vis);
...
public:
    ...
    ACDBCORE2D_PORT virtual void setTrueColors(const AcCmEntityColor *colors);
    ACDBCORE2D_PORT virtual AcCmEntityColor* trueColors() const;
    ACDBCORE2D_PORT virtual void setMappingCoords (MapChannel mapChannel, const AcGePoint3d* pCoords);
...
public:
    ...
    Acad::ErrorStatus font(ACHAR *& pTypeface,
                                   bool & bold, bool & italic, Charset& charset,
                                   Autodesk::AutoCAD::PAL::FontUtils::FontPitch& pitch,
                                   Autodesk::AutoCAD::PAL::FontUtils::FontFamily& family) const;
#endif
...
public:
    ...
    ACDBCORE2D_PORT AcGiHatchPatternDefinition(double angle,
                         double baseX,
                         double baseY,
                         double offsetX,
                         double offsetY,
...
private:
    friend class AcGiImpHatchPattern;
...
public:
    ...
    ACDBCORE2D_PORT AcGiGradientFill(double                              gradientAngle,
...
///////////////////////////////////////////////////////////////////////////////
// AcDbEntityParallelDrawPE and AcGiContextParallelDrawPE Protocol extensions
// used by the GS parallel tessellation feature
//
...
public:
    ...
    virtual Adesk::Boolean prepareForParallelDraw(AcDbEntity* pEnt, AcDbDwgFiler* pFiler) const = 0;
};
