...
public:
    ...
    GE_DLLEXPIMPORT AcGeEntity3d&    operator =  (AcGeEntity3d&& entity) noexcept;
...
protected:
    ...
    GE_DLLEXPIMPORT AcGeEntity3d (AcGeEntity3d&&) noexcept;
    ...
    GE_DLLEXPIMPORT void copyConstructor(const AcGeEntity3d&);
    GE_DLLEXPIMPORT void moveConstructor(AcGeEntity3d&&) noexcept;
};
