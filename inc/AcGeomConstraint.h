...
public:
  ...
  ///
  ACDBCORE2D_PORT virtual Acad::ErrorStatus getConnectedGeometries(AcArray<AcConstrainedGeometry*>& apConsGeoms) const;
  ...
  /// <returns> Returns Acad::eOk if successful. </returns>
  ///
  ACDBCORE2D_PORT virtual Acad::ErrorStatus getConnectedHelpParameters(AcArray<AcHelpParameter*>& apHelpParameters) const;
  ...
  /// </returns>
  ///
  ACDBCORE2D_PORT virtual AcHelpParameter*  getConnectedHelpParameterFor(const AcConstrainedGeometry* pConsGeom) const;
...
public:
  ...
  /// <returns> Returns Acad::eOk if successful. </returns>
  ///
  ACDBCORE2D_PORT Acad::ErrorStatus getConnectedEqualparamConstraints(AcArray<AcEqualHelpParameterConstraint*>& apEqualParamConstrs) const;
...
public:
  ...
  /// <returns> Returns Acad::eOk if successful. </returns>
  ///
  ACDBCORE2D_PORT Acad::ErrorStatus getOwnedConstraints(AcArray<AcGeomConstraint*>& apSubConstraints) const;

protected:

  /// <summary> Protected default constructor. </summary>
  /// 
  ACDBCORE2D_PORT AcCompositeConstraint(){}
};
