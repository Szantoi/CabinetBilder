...
//
HRESULT AXAUTOEXP 
AcAxErase(const AcDbObjectId& objId);

HRESULT AXAUTOEXP 
AcAxSetXData(const AcDbObjectId& objId, VARIANT type, VARIANT data);

HRESULT AXAUTOEXP 
AcAxGetXData(const AcDbObjectId& objId, BSTR bstrName, VARIANT* type, VARIANT* data);

HRESULT AXAUTOEXP 
AcAxGetObjectName(const AcDbObjectId& objId, BSTR* pName);

HRESULT AXAUTOEXP 
AcAxGetHandle(const AcDbObjectId& objId, BSTR* pHandle);

HRESULT AXAUTOEXP 
AcAxGetColor(const AcDbObjectId& objId, AcColor* pColor);

HRESULT AXAUTOEXP 
AcAxPutColor(const AcDbObjectId& objId, AcColor color);

HRESULT AXAUTOEXP
AcAxGetTrueColor(const AcDbObjectId& objId, IAcadAcCmColor** pColor);

HRESULT AXAUTOEXP 
AcAxPutTrueColor(const AcDbObjectId& objId, IAcadAcCmColor* color);

HRESULT AXAUTOEXP 
AcAxGetLayer(const AcDbObjectId& objId, BSTR* pLayer);

HRESULT AXAUTOEXP 
AcAxPutLayer(const AcDbObjectId& objId, BSTR layer);

HRESULT AXAUTOEXP 
AcAxGetLinetype(const AcDbObjectId& objId, BSTR* pLinetype);

HRESULT AXAUTOEXP 
AcAxPutLinetype(const AcDbObjectId& objId, BSTR linetype);

HRESULT AXAUTOEXP 
AcAxGetTransparency(const AcDbObjectId& objId, BSTR* pTransparency);

HRESULT AXAUTOEXP 
AcAxPutTransparency(const AcDbObjectId& objId, BSTR transparency);

HRESULT AXAUTOEXP 
AcAxGetShadowDisplay(const AcDbObjectId& objId, AcShadowDisplayType* pShadowDisplay);

HRESULT AXAUTOEXP 
AcAxPutShadowDisplay(const AcDbObjectId& objId, AcShadowDisplayType shadowDisplay);

HRESULT AXAUTOEXP 
AcAxEnableShadowDisplay(AcDbObjectId& objId, bool* pEnabled);

HRESULT AXAUTOEXP 
AcAxGetMaterial(const AcDbObjectId& objId, BSTR* pMaterial);

HRESULT AXAUTOEXP 
AcAxPutMaterial(const AcDbObjectId& objId, BSTR material);

HRESULT AXAUTOEXP 
AcAxGetLinetypeScale(const AcDbObjectId& objId, double* pLinetypeScale);

HRESULT AXAUTOEXP 
AcAxPutLinetypeScale(const AcDbObjectId& objId, double linetypeScale);

HRESULT AXAUTOEXP 
AcAxGetVisible(const AcDbObjectId& objId, VARIANT_BOOL* pVisible);

HRESULT AXAUTOEXP 
AcAxPutVisible(const AcDbObjectId& objId, VARIANT_BOOL visible);

HRESULT AXAUTOEXP 
AcAxArrayPolar(const AcDbObjectId& objId, LPDISPATCH pAppDisp, int numObjs,
               double fillAngle, VARIANT basePoint, VARIANT* pArrayObjs);

HRESULT AXAUTOEXP 
AcAxArrayRectangular(const AcDbObjectId& objId, LPDISPATCH pAppDisp, int numRows,
                     int numCols, int numLvls, double disRows, double disCols,
                     double disLvls, VARIANT* pArrayObjs);

HRESULT AXAUTOEXP 
AcAxHighlight(const AcDbObjectId& objId, VARIANT_BOOL bHighlight);

HRESULT AXAUTOEXP 
AcAxCopy(const AcDbObjectId& objId, LPDISPATCH pAppDisp, LPDISPATCH* pCopyObj,
         AcDbObjectId ownerId = AcDbObjectId::kNull);

HRESULT AXAUTOEXP 
AcAxMove(const AcDbObjectId& objId, VARIANT fromPoint, VARIANT toPoint);

HRESULT AXAUTOEXP 
AcAxRotate(const AcDbObjectId& objId, VARIANT basePoint, double rotationAngle);

HRESULT AXAUTOEXP 
AcAxRotate3D(const AcDbObjectId& objId, VARIANT point1, VARIANT point2,
             double rotationAngle);

HRESULT AXAUTOEXP 
AcAxMirror(const AcDbObjectId& objId, LPDISPATCH pAppDisp, VARIANT point1,
           VARIANT point2, LPDISPATCH* pMirrorObj);

HRESULT AXAUTOEXP 
AcAxMirror3D(const AcDbObjectId& objId, LPDISPATCH pAppDisp, VARIANT point1,
             VARIANT point2, VARIANT point3, LPDISPATCH* pMirrorObj);

HRESULT AXAUTOEXP 
AcAxScaleEntity(const AcDbObjectId& objId, VARIANT basePoint, double scaleFactor);

HRESULT AXAUTOEXP 
AcAxTransformBy(const AcDbObjectId& objId, VARIANT transMatrix);

HRESULT AXAUTOEXP 
AcAxUpdate(const AcDbObjectId& objId);

HRESULT AXAUTOEXP 
AcAxGetBoundingBox(const AcDbObjectId& objId, VARIANT* minPoint, VARIANT* maxPoint);

HRESULT AXAUTOEXP 
AcAxIntersectWith(const AcDbObjectId& objId, LPDISPATCH pEntity,
                  AcExtendOption option, VARIANT* intPoints);

HRESULT AXAUTOEXP 
AcAxGetPlotStyleName(const AcDbObjectId& objId, BSTR* plotStyleName);

HRESULT AXAUTOEXP 
AcAxPutPlotStyleName(const AcDbObjectId& objId, BSTR plotStyleName);

HRESULT AXAUTOEXP 
AcAxGetLineWeight(const AcDbObjectId& objId, ACAD_LWEIGHT* lineWeight);

HRESULT AXAUTOEXP 
AcAxPutLineWeight(const AcDbObjectId& objId, ACAD_LWEIGHT lineWeight);

HRESULT AXAUTOEXP 
AcAxGetHyperlinks(const AcDbObjectId& objId, LPDISPATCH pAppDisp,
                  IAcadHyperlinks** pHyperlinks);

HRESULT AXAUTOEXP 
AcAxHasExtensionDictionary(const AcDbObjectId& objId, VARIANT_BOOL* bHasDictionary);

HRESULT AXAUTOEXP 
AcAxGetExtensionDictionary(const AcDbObjectId& objId, LPDISPATCH pAppDisp,
...
HRESULT AXAUTOEXP
AcAxGetOwnerId(const AcDbObjectId& objId, Adesk::IntDbId * pOwnerId);
...
HRESULT AXAUTOEXP
AcAxGet_UIsolineDensity(const AcDbObjectId& objId, long* density);

HRESULT AXAUTOEXP
AcAxPut_UIsolineDensity(const AcDbObjectId& objId, long density);

HRESULT AXAUTOEXP
AcAxGet_VIsolineDensity(const AcDbObjectId& objId, long* density);

HRESULT AXAUTOEXP
AcAxPut_VIsolineDensity(const AcDbObjectId& objId, long density);

HRESULT AXAUTOEXP
AcAxGet_WireframeType(const AcDbObjectId& objId, AcWireframeType *type);

HRESULT AXAUTOEXP
AcAxPut_WireframeType(const AcDbObjectId& objId, AcWireframeType type);

HRESULT AXAUTOEXP
AcAxGetMaintainAssociativity(const AcDbObjectId& objId, int *maintainAssoc);

HRESULT AXAUTOEXP
AcAxPutMaintainAssociativity(const AcDbObjectId& objId, int maintainAssoc);

HRESULT AXAUTOEXP
AcAxGetShowAssociativity(const AcDbObjectId& objId, VARIANT_BOOL* bEnabled);

HRESULT AXAUTOEXP
AcAxPutShowAssociativity(const AcDbObjectId& objId, VARIANT_BOOL bEnabled);

HRESULT AXAUTOEXP
AcAxGetEdgeExtensionDistances(const AcDbObjectId& objId, VARIANT *extDistances);

HRESULT AXAUTOEXP
AcAxPutEdgeExtensionDistances(const AcDbObjectId& objId, VARIANT extDistances);

HRESULT AXAUTOEXP
AcAxGetSurfTrimAssociativity(const AcDbObjectId& objId, VARIANT *associative);

HRESULT AXAUTOEXP
AcAxPutSurfTrimAssociativity(const AcDbObjectId& objId, VARIANT associative);
