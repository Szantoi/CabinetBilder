...
public:
    ...
    // Fast interactivity status: 
    // trace some interactivity behavior triggered by middle mouse zoom/pan with high frequency.
...
public:
    ...
    {
        kFM_Start = -3,
        kFM_Legacy = kFM_Start, // Legacy mode is always recognized as 'HQ' off.
        kFM_ClassicDx9,         // Classic mode used by Dx9 with 'HQ' off.
        kFM_ClassicDx11,        // Classic mode used by Dx11 with 'HQ' off.

        kFM_Software,           // Software mode.
        kFM_Basic,              // Basic mode.
        kFM_Medium,             // Medium mode.
        kFM_Advanced,           // Advanced mode.
    ...
    struct EffectStatus
    {
        AcUniqueString::value pUniqueString;            //Unique identifier for string
    ...
    virtual void                setFeatureEnabled                (const AcUniqueString::value ,
                                                                  bool bEnable = true)          = 0;
    virtual int                 getFeatureVal                    (const AcUniqueString::value ) const  = 0;
    virtual void                setFeatureVal                    (const AcUniqueString::value ,
                                                                  int iVal = 0)                 = 0;
...
public:
    ...
    static constexpr const AcUniqueString::value k2DDrawing          = AcUniqueString::drawing2D();          // "2D Drawing"
    static constexpr const AcUniqueString::value k3DDrawing          = AcUniqueString::drawing3D();          // "3D Drawing"
    static constexpr const AcUniqueString::value k3DDrawing2         = AcUniqueString::drawing3D2();         // "3D Drawing2"
    static constexpr const AcUniqueString::value k3DSelection        = AcUniqueString::selection3D();        // "3D Selection"
    static constexpr const AcUniqueString::value k3DRapidRTRendering = AcUniqueString::rapidRTRendering3D(); // "RapidRT Rendering"
