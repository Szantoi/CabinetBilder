...
inline void
AcDbFullSubentPath::setObjectIds(const AcDbObjectIdArray& objectIds)
{
    mObjectIds = objectIds;
}

inline void
AcDbFullSubentPath::setSubentId(const AcDbSubentId& subentId)
{
    mSubentId = subentId;
}
