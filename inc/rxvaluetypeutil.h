...
// Specialization implementation for AcDbObjectId is implemented in Core2dValueTypes.xaml.cpp
class AcDbObjectId;
template<>
int AcRxValueTypePOD<AcDbObjectId>::subToString(const void* instance, ACHAR* buffer, size_t sizeInACHARs, AcRxValueType::StringFormat format) const;
template<>
bool AcRxValueTypePOD<AcDbObjectId>::subEqualTo(const void* a, const void* b) const;
