...
public:
    ...
    /// </summary>
    ///
    /// <param name="pBlockTableRecord">
    /// A pointer to an AcDbBlockTableRecord.
    /// </param>
    ///
    /// <returns>
    /// Returns true if <paramref name="pBlockTableRecord"/> is an
    /// AcDbBlockTableRecord and contains dynamic block information.
    /// </returns>
    ACDBCORE2D_PORT static bool isDynamicBlock(AcDbBlockTableRecord* pBlockTableRecord);
    ...
    /// </remarks>
    ACDBCORE2D_PORT Acad::ErrorStatus getAnonymousBlockIds 
