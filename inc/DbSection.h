...
public:
    GEOMENT_DECLARE_MEMBERS(AcDbSection);
...
#define AcDbSection_Deprecated_ACHAR_Methods
#ifdef AcDbSection_Deprecated_ACHAR_Methods
    /// <summary>
    /// This function returns name of the section plane.
    /// </summary>
...
public:
    GEOMENT_DECLARE_MEMBERS(AcDbSectionSettings);
