...
{
public: 
    ACDB_DECLARE_MEMBERS(AcDbAssocDependency);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject. </param>
    ///
    ACDBCORE2D_PORT explicit AcDbAssocDependency(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDBCORE2D_PORT AcDbObjectId owningAction() const { return ownerId(); }
    ...
    ///
    ACDBCORE2D_PORT void erased(const AcDbObject* dbObj, Adesk::Boolean isErasing = true) override;
    ...
    ///
    ACDBCORE2D_PORT void setPrevDependencyOnObject(const AcDbObjectId& depId);
    /// <summary> For Autodesk internal use only. </summary>
    ///
    ACDBCORE2D_PORT void setNextDependencyOnObject(const AcDbObjectId& depId);
private:
