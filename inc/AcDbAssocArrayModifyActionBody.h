...
public:
    ...
    ///
    ACDBCORE2D_PORT explicit AcDbAssocArrayModifyActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);

    /// <summary> Destructor. </summary>
    ///
    ACDBCORE2D_PORT ~AcDbAssocArrayModifyActionBody(void);
    ...
    ///
    ACDBCORE2D_PORT bool controlsItem(const AcDbAssocArrayItem& item) const override;
