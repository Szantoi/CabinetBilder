...
public:
    ...
    ///
    ACDBCORE2D_PORT virtual AcDbAssocPersSubentId* createNewPersSubent(AcDbEntity*                 pEntity,
    ...
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus releasePersSubent(AcDbEntity*                  pEntity, 
                                                AcDbDatabase*                pDatabase,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus makePersSubentPurgeable(AcDbEntity*                  pEntity, 
                                                      AcDbDatabase*                pDatabase,
                                                      const AcDbAssocPersSubentId* pPerSubentId,
                                                      bool                         yesNo) 
    { 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getTransientSubentIds(const AcDbEntity*            pEntity, 
                                                    AcDbDatabase*                pDatabase,
                                                    const AcDbAssocPersSubentId* pPersSubentId,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getEdgeVertexSubentities(const AcDbEntity*      pEntity,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getSplineEdgeVertexSubentities(const AcDbEntity*      pEntity,
                                                             const AcDbSubentId&    edgeSubentId,
                                                             AcDbSubentId&          startVertexSubentId,
                                                             AcDbSubentId&          endVertexSubentId,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getVertexSubentityGeometry(const AcDbEntity*   pEntity,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getEdgeSubentityGeometry(const AcDbEntity*   pEntity,
                                                       const AcDbSubentId& edgeSubentId,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getFaceSubentityGeometry(const AcDbEntity*   pEntity,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus setVertexSubentityGeometry(AcDbEntity*         pEntity,
                                                         const AcDbSubentId& vertexSubentId,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus setEdgeSubentityGeometry(AcDbEntity*         pEntity,
                                                       const AcDbSubentId& edgeSubentId,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus setFaceSubentityGeometry(AcDbEntity*         pEntity,
                                                       const AcDbSubentId& faceSubentId,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getSubentityGeometry(const AcDbEntity*   pEntity,
                                                   const AcDbSubentId& subentId,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus setSubentityGeometry(AcDbEntity*         pEntity,
                                                   const AcDbSubentId& subentId,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getFaceSilhouetteGeometry(AcDbEntity*                  pEntity,
                                                        AcRxObject*                  pContext,
                                                        const AcDbSubentId&          faceSubentId,
    ...
    ///
    ACDBCORE2D_PORT virtual AcDbAssocPersSubentId* createNewPersFaceSilhouetteId(AcDbEntity*                  pEntity,
                                                                 AcDbDatabase*                pDatabase,
                                                                 AcRxObject*                  pContext,
                                                                 const AcDbCompoundObjectId&  /*compId*/,
                                                                 const AcDbSubentId&          faceSubentId,
    ...
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getTransientFaceSilhouetteIds(AcDbEntity*                  pEntity,
                                                            AcDbDatabase*                pDatabase,
                                                            AcRxObject*                  pContext,
                                                            const AcDbSubentId&          faceSubentId,
                                                            const AcGeMatrix3d*          pEntityTransform,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getSubentGeometryXform(const AcDbEntity*        pEntity,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus mirrorPersSubent(const AcDbEntity*      pMirroredEntity,
                                               AcDbDatabase*          pDatabase,
...
/// <summary>
/// This class derives from AcDbAssocPersSubentiIdPE and adds a new virtual method.  Deriving
/// a new class was necessary to maintain API compatibility.  This class will be merged into
/// the AcDbAssocPersSubentIdPE class the next time we break API compatibility.
/// </summary>
///
...
public:
    ...
    /// <summary>
    /// Inverse of redirectDependencyAttachment(), allows to obtain the original object
    /// from the redirected one.
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getUnredirectedObject(const AcDbSubentId&          redirectedSubentId,
                                                    const AcDbCompoundObjectId&  redirectedCompoundObjectId,
                                                    AcDbCompoundObjectId&        originalCompoundObjectId)
    {
        ADESK_UNREFED_PARAM(redirectedSubentId);
        ADESK_UNREFED_PARAM(redirectedCompoundObjectId);
        ADESK_UNREFED_PARAM(originalCompoundObjectId);
        return Acad::eNotApplicable;
    }
};
