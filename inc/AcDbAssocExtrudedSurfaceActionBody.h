...
{
public:
    GEOMENT_DECLARE_MEMBERS(AcDbAssocExtrudedSurfaceActionBody);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject explanation. </param>
    ///
    ACDB_PORT explicit AcDbAssocExtrudedSurfaceActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDB_PORT Acad::ErrorStatus setTaperAngle( double dTaperAngle, const AcString& expression = AcString(), 
    ...
    ///
    ACDB_PORT double            taperAngle(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
    ...
    ///
    ACDB_PORT double            height(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
