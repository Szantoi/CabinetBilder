...
public:
    ...
    /// 
    ACDBCORE2D_PORT ~AcDbAssocArrayParameters(void);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus setGeomParam(const AcString&   paramName,
    ...
    /// </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus getGeomParam(const AcString&   paramName,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getItemPosition(const AcDbItemLocator& locator, 
...
protected:
    ...
    ACDBCORE2D_PORT explicit AcDbAssocArrayParameters(AcDbImpAssocArrayParameters* pSelf = NULL);
