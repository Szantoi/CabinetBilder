...
{
public:
    ACDB_DECLARE_MEMBERS(AcDbAssocArrayActionBody);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject. </param>
    ///
    ACDBCORE2D_PORT explicit AcDbAssocArrayActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);

    /// <summary> Destructor. </summary>
    ///
    ACDBCORE2D_PORT ~AcDbAssocArrayActionBody(void);
    ...
    /// item. </returns>
    ///
    ACDBCORE2D_PORT static AcDbObjectId getControllingActionBody(const AcDbEntity* pEntity,
    ...
    /// <returns> Acad::ErrorStatus </returns>
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus resetArrayItems(AcDbObjectId arrayEntityId,
    ...
    /// <returns> Acad::ErrorStatus </returns>
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus createInstance(const AcDbObjectIdArray& sourceEntites, 
    ...
    /// <returns> Acad::ErrorStatus </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus addMoreObjectsToDeepCloneOverride(AcDbIdMapping& idMap, 
