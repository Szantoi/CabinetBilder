...
public:
    ...
    int     ImageWidth () override;    // Override to allow setting of 0 image width. INTERNAL USE ONLY
    ...
    // MRU control
protected:
    void    DrawItemImage (CDC& dc, CRect& r, INT_PTR cargo) override;   // INTERNAL USE ONLY
    int     CalcItemHeight () override;                              // INTERNAL USE ONLY
    void    OnAddItems () override;
    void    OnComboBoxInit () override;                              // INTERNAL USE ONLY
...
protected:
    void    OnAddItems () override;
    BOOL    OnSelectOther (BOOL isOther2, int curSel, int& newSel) override; // INTERNAL USE ONLY
    void    OnComboBoxInit () override;                                      // INTERNAL USE ONLY       
