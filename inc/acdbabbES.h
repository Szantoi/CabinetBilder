...
#if defined(_MSC_VER) && __cpp_using_enum
// This seems to crash clang
using enum Acad::ErrorStatus;
#else

const Acad::ErrorStatus eOk = Acad::eOk;
const Acad::ErrorStatus eNotImplemented= Acad::eNotImplemented;
...
const Acad::ErrorStatus eSrsCompoundCrsDatumNotMatch = Acad::eSrsCompoundCrsDatumNotMatch;
const Acad::ErrorStatus eSrsCompoundCrsUnitNotMatch = Acad::eSrsCompoundCrsUnitNotMatch;

#endif // ! MSVC || ! __cpp_using_enum
