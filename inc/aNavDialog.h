...
public:
    ...
    /// <summary>
    /// Get whether to show FTP shortcut in the places list for FileNav dialog.
    /// </summary>
    /// <returns> 
    /// Return TRUE if not to show FTP shortcut. Otherwise, return FALSE. 
    /// </returns> 
    BOOL    GetNoFTPInPlaces();

    /// <summary>
    /// Set whether to show FTP shortcut in the places list for FileNav dialog.
    /// </summary>
    /// <param name="noFTPInPlaces"> 
    /// Specify TRUE or FALSE.
    /// </param>
    void    SetNoFTPInPlaces(BOOL noFTPInPlaces);

    /// <summary>
    /// Get whether to show Favorites shortcut in the places list for FileNav
    /// dialog.
    /// </summary>
    /// <returns> 
    /// Return TRUE if not to show Favorites shortcut. Otherwise, return FALSE. 
    /// </returns> 
    BOOL    GetNoFavoritesInPlaces();

    /// <summary>
    /// Set whether to show Favorites shortcut in the places list for FileNav
    /// dialog.
    /// </summary>
    /// <param name="noFavorites"> 
    /// Specify TRUE or FALSE.
    /// </param>
...
protected:
    ...
    ADUI_REPLY OnNotifyControlChange(UINT controlId, LPARAM lParam) override;
