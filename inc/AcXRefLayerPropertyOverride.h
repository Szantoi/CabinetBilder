...
public:
    ...
    /// </returns>
    ACDBCORE2D_PORT static bool hasXRefLayerOverride(const AcDbObjectId& hostLayerId, XRefLayerPropertyOverrideType property);
    ...
    /// </returns>
    ACDBCORE2D_PORT static Acad::ErrorStatus addXRefLayerOverride(const AcDbObjectId& hostLayerId, XRefLayerPropertyOverrideType property);
    ...
    ACDBCORE2D_PORT static Acad::ErrorStatus removeXRefLayerOverride(const AcDbObjectId& hostLayerId, XRefLayerPropertyOverrideType property);
	...
	ACDBCORE2D_PORT static Acad::ErrorStatus removeXRefLayerOverride(AcDbDatabase* pHostDb, XRefLayerPropertyOverrideType property);
    ...
    /// </returns>
    ACDBCORE2D_PORT static Acad::ErrorStatus removeXRefLayerOverrides(const AcDbObjectId& hostLayerId);
