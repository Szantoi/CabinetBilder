...
#define AcDbMText_Deprecated_ACHAR_Methods
#ifdef AcDbMText_Deprecated_ACHAR_Methods
    ...
    //  Return points marking mtext box by line
    //
    ACDBCORE2D_PORT void getBoundingPointsByLine(AcArray<AcGePoint3dArray>&) const;

    // For pick in space hit test if TEXTGAPSELECTION is enabled
