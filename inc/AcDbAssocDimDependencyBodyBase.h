...
{
public:
    ACDB_DECLARE_MEMBERS(AcDbAssocDimDependencyBodyBase);

    /// <summary> Default constructor. </summary>
    ACDBCORE2D_PORT explicit AcDbAssocDimDependencyBodyBase(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDBCORE2D_PORT class AcExplicitConstraint* constraint() const;
    ...
    ///
    ACDBCORE2D_PORT AcDbObjectId variable() const; // of AcDbAssocVariable
    ...
    /// <returns> Acad::eOk if successful. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus getConstrainedGeoms(AcArray<AcConstrainedGeometry*>& geoms) const;
    ...
    /// <returns> Acad::eOk if successful. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus getVariableNameAndExpression(AcString& name, AcString& expression, AcString& value) const;
    ...
    /// <returns> Acad::eOk if successful. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus getEntityNameAndExpression(AcString& name, AcString& expression) const;
    ...
    /// <returns> Acad::eOk if successful. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus setVariableNameAndExpression(const AcString& name, const AcString& expression);
    ...
    /// <returns> Acad::eOk if successful. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus setEntityNameAndExpression(const AcString& name, const AcString& expression, const AcString& value);
    ...
    /// <returns> Acad::eOk if successful. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus setNameAndExpression(const AcString& name, const AcString& expression); // Both variable and entity
    ...
    ///
    ACDBCORE2D_PORT bool isConstraintActive() const; // Has DCM d_node or r_node
    ...
    /// <returns> Acad::eOk if successful. </returns>
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus getFromEntity(const AcDbObjectId& entityId, AcDbObjectId& dimDepBodyId);
    ...
    /// <returns> Acad::eOk if successful. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus entityAttachmentPointMoved(const AcArray<AcDbSubentGeometry>& newAttachedGeometries,
    ...
    /// <returns> Acad::eOk if successful. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus isRelevantChangeOverride(bool& isRelevChange) const override;
    ...
    ///
    ACDBCORE2D_PORT void modifiedOverride(const AcDbObject* pDbObj) override;
    ...
    ///
    ACDBCORE2D_PORT void erasedOverride(const AcDbObject* pDbObj, Adesk::Boolean isErasing) override;
    ...
    /// <returns> Acad::eOk if successful. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus subErase(Adesk::Boolean erasing) override;
    ...
    ///
    ACDBCORE2D_PORT static AcString formatToCurrentPrecision(const AcString& expression, bool isAngular);
