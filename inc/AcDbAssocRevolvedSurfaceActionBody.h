...
{
public:
    GEOMENT_DECLARE_MEMBERS(AcDbAssocRevolvedSurfaceActionBody);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject explanation. </param>
    ///
    ACDB_PORT explicit AcDbAssocRevolvedSurfaceActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDB_PORT Acad::ErrorStatus setRevolveAngle(double angle, const AcString& expression = AcString(), 
    ...
    ///
    ACDB_PORT double revolveAngle(AcString& expression = dummyString(), AcString& evaluatorId = dummyString()) const;
