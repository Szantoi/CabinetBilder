...
// --------------------------
// IDynamicPropertyGetDispId interface
// Implement this class to fetch the property's DispId
//--------------------------
// {3B812F96-F188-40C9-B6D7-859501011B2B}
DEFINE_GUID(IID_IDynamicPropertyGetDispId, 0x3b812f96, 0xf188, 0x40c9, 0xb6, 0xd7, 0x85, 0x95, 0x1, 0x1, 0x1b, 0x2b);

interface DECLSPEC_UUID("3B812F96-F188-40C9-B6D7-859501011B2B")
    IDynamicPropertyGetDispId : public IUnknown
{
    BEGIN_INTERFACE
    // *** IUnknown methods ****
    ...
    // *** IDynamicPropertyGetDispId methods ***
    // Unique property ID
