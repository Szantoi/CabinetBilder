...
template<>
struct AcRxValueType::Desc<uint32_t>
{
    ACBASE_PORT static const AcRxValueType& value() throw();
    static void del();
};
...
template<>
struct AcRxValueType::Desc<uint64_t>
{
    ACBASE_PORT static const AcRxValueType& value() throw();
    static void del();
};
...
template<>
ACDBCORE2D_PORT AcRxValue::AcRxValue(const AcDbSweepOptions& sweepOptions) throw();
#pragma endregion
...
template<>
ACDBCORE2D_PORT AcRxValue::AcRxValue(const AcDbLoftOptions& loftOptions) throw();
#pragma endregion
...
template<>
ACDBCORE2D_PORT AcRxValue::AcRxValue(const AcDbBlockParamValueSet& blcParamValueSet) throw();
#pragma endregion
...
template<>
ACDBCORE2D_PORT AcRxValue::AcRxValue(const AcDbBlkParamValueSetValuesArray& blockParamValueSetArr) throw();
#pragma endregion
