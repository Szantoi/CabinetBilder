...
{
public:
  ACDB_DECLARE_MEMBERS(AcDbAssoc2dConstraintGroup);
  ...
  ///
  ACDBCORE2D_PORT SolutionStatus solutionStatus(bool bAlsoCheckForConstraints = true) const;
  ...
  /// <returns>SolutionStatus</returns>
  ///
  ACDBCORE2D_PORT SolutionStatus geometryStatus(const AcConstrainedGeometry* pConsGeom) const;
  ...
  /// <returns>SolutionStatus</returns>
  ///
  ACDBCORE2D_PORT SolutionStatus constraintStatus(const AcGeomConstraint* pConstraint) const;
  ...
  ///
  ACDBCORE2D_PORT Acad::ErrorStatus addConstrainedGeometry(const AcDbFullSubentPath& subentPath, AcConstrainedGeometry*& pConsGeom);
  ...
  /// <returns>Returns Acad::eOk if successful.</returns>
  ///
  ACDBCORE2D_PORT Acad::ErrorStatus deleteConstrainedGeometry(const AcDbObjectId& geomDependencyId);
  ...
  /// <returns>Returns Acad::eOk if successful.</returns>
  ///
  ACDBCORE2D_PORT Acad::ErrorStatus getConstrainedGeometry(const AcDbFullSubentPath& fullSubentPath,
  ...
  /// <returns>Returns Acad::eOk if successful.</returns>
  ///
  ACDBCORE2D_PORT Acad::ErrorStatus getConstrainedGeometry(const AcDbAssocGeomDependency* pGeomDependency,
                                           AcConstrainedGeometry*&   pConsGeom,
  ...
  /// <returns>Returns Acad::eOk if successful.</returns>
  ///
  ACDBCORE2D_PORT Acad::ErrorStatus getConstrainedGeometries(AcArray<AcConstrainedGeometry*>& aConstGeom) const;
  ...
  /// </returns>
  ///
  ACDBCORE2D_PORT Acad::ErrorStatus addGeometricalConstraint(AcGeomConstraint::GeomConstraintType type, 
  ...
  /// <returns>Returns Acad::eOk if successful.</returns>
  ///
  ACDBCORE2D_PORT Acad::ErrorStatus addDistanceConstraint(AcConstrainedGeometry* pConsGeom1,
  ...
  /// <returns>Returns Acad::eOk if successful.</returns>
  ///
  ACDBCORE2D_PORT Acad::ErrorStatus addAngleConstraint(AcConstrainedLine* pConsLine1,
  ...
  /// </param>
  /// <returns>Returns Acad::eOk if successful.</returns>
  ACDBCORE2D_PORT Acad::ErrorStatus add3PointAngleConstraint(AcConstrainedPoint* pConsPoint1,
  ...
  /// <returns>Returns Acad::eOk if successful.</returns>
  ///
  ACDBCORE2D_PORT Acad::ErrorStatus addRadiusDiameterConstraint(AcConstrainedGeometry* pConsGeom,
  ...
  /// <returns>Returns Acad::eOk if successful.</returns>
  ///
  ACDBCORE2D_PORT Acad::ErrorStatus getConstraints(AcArray<AcGeomConstraint*>& apConstraints) const;
  ...
  /// <returns>Returns Acad::eOk if successful.</returns>
  ///
  ACDBCORE2D_PORT Acad::ErrorStatus getAllConnectedGeomDependencies(const AcDbObjectIdArray& srcGeomDependencyIds,
  ...
  ///
  ACDBCORE2D_PORT static void addGlobalCallback(class AcDbAssoc2dConstraintCallback* pCallback);
  ...
  ///
  ACDBCORE2D_PORT static void removeGlobalCallback(class AcDbAssoc2dConstraintCallback* pCallback);
  ...
  /// </returns>
  ///
  ACDBCORE2D_PORT static class AcDbAssoc2dConstraintCallback* globalCallback();
  ...
  /// </para></summary>
  /// 
  ACDBCORE2D_PORT static void setDoNotCheckNewlyAddedConstraints(bool doNotCheck);

  ACDBCORE2D_PORT static bool doNotCheckNewlyAddedConstraints();
...
public:
  ACDBCORE2D_PORT virtual ~AcAutoConstrainEvaluationCallback() { }
  ...
  ///
  ACDBCORE2D_PORT virtual void getConstraintPriorityOverride(AcGeomConstraint::GeomConstraintType type, 
  ...
  /// </param>
  /// 
  ACDBCORE2D_PORT virtual void getAutoConstrainPriority(AcArray<AcGeomConstraint::GeomConstraintType>& constraintList) const
  {
