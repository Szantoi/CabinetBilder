...
public:
    ...
    void ThemeModified(const CAdUiTheme * pTheme, AdUiThemeElement element) override;  // INTERNAL USE ONLY
...
public:
    ...
    /// </returns>
    CAdUiTheme * SetTheme(CAdUiTheme *pTheme) override;
...
protected:
    ...
    ADUI_REPLY OnGetTipSupport (CPoint& p) override;
