...
{
public: 
    ACDB_DECLARE_MEMBERS(AcDbAssocValueDependency);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject. </param>
    ///
    ACDBCORE2D_PORT explicit AcDbAssocValueDependency(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDBCORE2D_PORT const AcString& valueName() const;
    ...
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus setValueName(const AcString& newValueName);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus getDependentOnObjectValue(AcDbEvalVariant& objectValue) const;
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus setDependentOnObjectValue(const AcDbEvalVariant& newObjectValue);
