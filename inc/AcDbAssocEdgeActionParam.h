...
public:
    ...
    ///
    ACDBCORE2D_PORT explicit AcDbAssocEdgeActionParam(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus setEdgeRef(const AcDbEdgeRef& edgeRef, bool isReadDependency = true, bool isWriteDependency = false, int dependencyOrder = 0);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus setEdgeSubentityGeometry(const AcGeCurve3d* pNewEdgeCurve);
