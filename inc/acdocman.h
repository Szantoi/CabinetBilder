...
public:
    ...
    ACCORE_PORT virtual ~AcApDocManagerReactor();
...
public:
    ...
    ADESK_DEPRECATE_FOR_INTERNAL_USE virtual AcApDocumentIterator* newAcApDocumentIterator() = 0;

    auto getDocumentIterator() {
        ADESK_SUPPRESS_DEPRECATED
        return std::unique_ptr<AcApDocumentIterator>(newAcApDocumentIterator());
    }
