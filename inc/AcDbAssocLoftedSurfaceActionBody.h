...
public:
    ...
    GEOMENT_DECLARE_MEMBERS(AcDbAssocLoftedSurfaceActionBody);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject explanation. </param>
    ///
    ACDB_PORT explicit AcDbAssocLoftedSurfaceActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDB_PORT Acad::ErrorStatus getContinuity( ProfileType type, int &continuity, AcString& expression = dummyString(), 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus setContinuity( ProfileType type, int continuity, const AcString& expression = AcString(), 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus getBulge( ProfileType type, double &bulge, AcString& expression = dummyString(), 
        AcString& evaluatorId = dummyString() ) const;
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus setBulge( ProfileType type, double bulge, const AcString& expression = AcString(), 
        const AcString& evaluatorId = AcString() );
