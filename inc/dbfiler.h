...
// 
{
  ...
  public:
    ...
    // Deprecated.  Please use readBool() and writeBool() instead
    virtual Acad::ErrorStatus   readBoolean(Adesk::Boolean* pVal)
    {
        return this->readBool(pVal);
    }
...
inline Acad::ErrorStatus AcDbDwgFiler::readItem(AcString & rVal)
