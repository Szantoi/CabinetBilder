...
{
public:
    GEOMENT_DECLARE_MEMBERS(AcDbAssocAsmBodyActionParam);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject explanation. </param>
    ///
    ACDB_PORT explicit AcDbAssocAsmBodyActionParam(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDB_PORT virtual Acad::ErrorStatus setBody(const AcDbEntity* pAsmEntity, bool isReadDependency = true, bool isWriteDependency = false, int dependencyOrder = 0);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT virtual Acad::ErrorStatus setBody(AcDbObjectId asmEntityId, bool isReadDependency = true, bool isWriteDependency = false, int dependencyOrder = 0);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus getDependentOnCompoundObject(AcDbCompoundObjectId& compoundId) const;
};
