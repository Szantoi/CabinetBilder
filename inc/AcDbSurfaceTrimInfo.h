...
public:
    ...
    ///
    ACDB_PORT AcDbSurfaceTrimInfo();

    /// <summary> Default destructor. </summary>
    ///
    ACDB_PORT virtual ~AcDbSurfaceTrimInfo();
    ...
    /// </param>
    ACDB_PORT void setTrimInfo( const AcDbCompoundObjectId& curveId, const AcGeVector3d & projVector, TrimRelation relation );
    ...
    /// the relation between tool and trimmed area on blank - inside the tool or outside
    /// </param>
    ACDB_PORT void setTrimInfo( ENTITY *pWireBody, const AcGeVector3d& projVector, TrimRelation relation);
    ...
    /// </param>
    ACDB_PORT void setTrimInfo( const AcDbCompoundObjectId &surfaceId, TrimRelation relation, const AcDbSubentId& subentId);
    ...
    /// face subentity id that will be used for trimming if the surface has more than one faces
    /// </param>
    ACDB_PORT void setTrimInfo( ENTITY *pAsmBody, TrimRelation relation, const AcDbSubentId& subentId );

    /// <summary>
    /// if the tool is a curve (either an object of AcDbCurve or a wire body in ASM)
    /// </summary> 
    ///
    ACDB_PORT bool isCurve() const;
    ...
    /// </summary> 
    ///
    ACDB_PORT ENTITY *toolBody() const;
    ...
    /// </summary> 
    ///
    ACDB_PORT void setToolBody(ENTITY *pEntity);
    ...
    /// </summary> 
    ///
    ACDB_PORT AcDbCompoundObjectId toolBodyId() const;
    ...
    /// </summary> 
    ///
    ACDB_PORT void setToolBodyId( const AcDbCompoundObjectId &toolId );

    /// <summary>
    /// returns the TrimRelation between the tool and trimmed area on the blank
    /// </summary> 
    ///
    ACDB_PORT TrimRelation relation() const;

    /// <summary>
    /// sets the TrimRelation between the tool and trimmed area on the blank
    /// </summary> 
    ///
    ACDB_PORT void setRelation( TrimRelation relation );
    ...
    /// </summary> 
    ///
    ACDB_PORT AcGeVector3d projVector() const;
    ...
    /// </summary> 
    ///
    ACDB_PORT void setProjVector(const AcGeVector3d& projVector);
    ...
    /// </summary> 
    ///
    ACDB_PORT AcDbSubentId faceSubentId() const;
private:
    bool mbCurve;
