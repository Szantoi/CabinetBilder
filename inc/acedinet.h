...
// RETURN VALUE   Adesk::kTrue on success; Adesk::kFalse on failure
//
// Note: this first overload does not take a size arg and is deprecated.
// Please use the 2nd overload instead
//
ACAD_PORT bool
...
ACAD_PORT bool
acedGetUserFavoritesDir(/*[out]*/AcString & sFavoritesDir);
...
ACAD_PORT bool
acedResolveInternetShortcut(/*[in]*/const ACHAR* szLinkFile, /*[out]*/AcString & sUrl);
