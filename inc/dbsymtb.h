...
{
public:
    ACDB_DECLARE_MEMBERS_ABSTRACT(AcDbSymbolTableRecord);
    AcDbSymbolTableRecord();
    ~AcDbSymbolTableRecord();

    typedef AcDbSymbolTable TableType;

#define AcDbSymTab_ACHAR_METHODS
#ifdef AcDbSymTab_ACHAR_METHODS
    Acad::ErrorStatus getName(ACHAR*& pName) const;     // deprecated
#endif
    Acad::ErrorStatus getName(AcString & sName) const;
    AcString name(Acad::ErrorStatus *pE = nullptr) const;
...
public:
    ...
    Acad::ErrorStatus decomposeForSave(AcDb::AcDbDwgVersion ver,
...
#endif
    AcString          plotStyleName(const AcDbObjectId& viewportId,
                                    bool * pIsOverride = nullptr,
                                    Acad::ErrorStatus * pE = nullptr) const;
...
{
public:
    ACDB_DECLARE_MEMBERS_ABSTRACT(AcDbAbstractViewTableRecord);
...
public:
    ...
    //
    // Replaced by dimpost() and dimapost() (see inlines below)
#ifdef AcDbSymTab_ACHAR_METHODS
...
{
public:
    ACDB_DECLARE_MEMBERS_ABSTRACT(AcDbSymbolTable);
    AcDbSymbolTable();
    ~AcDbSymbolTable();

    typedef AcDbSymbolTableRecord RecordType;
    typedef AcDbSymbolTableIterator IteratorType;
...
public:
    ...
    typedef AcDbBlockTableIterator IteratorType;
...
public:
    ...
    typedef AcDbLayerTableIterator IteratorType;
...
public:
    ...
    typedef AcDbTextStyleTableIterator IteratorType;
...
public:
    ...
    typedef AcDbLinetypeTableIterator IteratorType;
...
{
public:
    ACDB_DECLARE_MEMBERS_ABSTRACT(AcDbAbstractViewTable);
...
public:
    ...
    typedef AcDbViewTableIterator IteratorType;
...
public:
    ...
    typedef AcDbUCSTableIterator IteratorType;
...
public:
    ...
    typedef AcDbViewportTableIterator IteratorType;
...
public:
    ...
    typedef AcDbRegAppTableIterator IteratorType;
...
public:
    ...
    typedef AcDbDimStyleTableIterator IteratorType;
...
inline AcString AcDbSymbolTableRecord::name(Acad::ErrorStatus *pE) const
{
    AcString sName;
    const Acad::ErrorStatus es = this->getName(sName);
    if (pE != nullptr)
        *pE = es;
    return sName;
}

inline AcString AcDbLayerTableRecord::plotStyleName(Acad::ErrorStatus * pE) const
{
    AcString sName;
    const Acad::ErrorStatus es = this->plotStyleName(sName);
    if (pE != nullptr)
        *pE = es;
    return sName;
}

inline AcString AcDbLayerTableRecord::plotStyleName(const AcDbObjectId& viewportId,
                                        bool * pIsOverride,
                                        Acad::ErrorStatus * pE) const
{
    AcString sName;
    bool bIsOverride;
    const Acad::ErrorStatus es = this->plotStyleName(viewportId, sName, bIsOverride);
    if (pIsOverride != nullptr)
        *pIsOverride = bIsOverride;
    if (pE != nullptr)
        *pE = es;
    return sName;
}
