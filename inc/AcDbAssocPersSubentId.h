...
public:
    ...
    ACRX_DECLARE_MEMBERS_EXPIMP(AcDbAssocPersSubentId, ACDBCORE2D_PORT);

    /// <summary> Default constructor. </summary>
    ACDBCORE2D_PORT AcDbAssocPersSubentId() {}
    ...
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus release(AcDbEntity* pEntity, AcDbDatabase* pDatabase) const;
    ...
    ///
    ACDBCORE2D_PORT virtual AcDb::SubentType subentType(const AcDbEntity* pEntity, 
    ...
    /// </returns>
    ///
    ACDBCORE2D_PORT virtual int transientSubentCount(const AcDbEntity* pEntity,
    ...
    ///
    ACDBCORE2D_PORT virtual bool isNull() const = 0;
    ...
    ///
    ACDBCORE2D_PORT virtual bool isEqualTo(const AcDbEntity*            pEntity, 
                           AcDbDatabase*                pDatabase,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus mirror(const AcDbEntity* pMirroredEntity,
                                     AcDbDatabase*     pDatabase);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus audit(AcDbAuditInfo* /*pAuditInfo*/) { 
        return Acad::eOk; 
    }
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus copyFrom(const AcRxObject* pSource) override;
