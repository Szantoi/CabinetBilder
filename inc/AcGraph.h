...
typedef NodeIdToPtrMap::const_iterator const_iterator;
    ...
    /// <returns> Acad::ErrorStatus </returns>
    ACDBCORE2D_PORT Acad::ErrorStatus getRelatedNodes(const AcArray<AcGraphNode *> &nodes, AcArray<AcGraphNode *> &relatedNodes) const;
    ...
    ACDBCORE2D_PORT virtual Adesk::UInt32     graphId() const;
    ...
    /// </summary>
    /// <returns> none </returns>
    ACDBCORE2D_PORT virtual void              setGraphId(Adesk::UInt32 id);
