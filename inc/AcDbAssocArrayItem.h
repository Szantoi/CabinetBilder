...
public:
    ...
    ///
    ACDBCORE2D_PORT int operator [] (IndexType i) const { return mIndices[i]; }
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT bool operator >  (const AcDbItemLocator& other) const { return compareWith(other) > 0; }
...
public:
    ...
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus getTransform(AcGeMatrix3d& transform, bool bCompounded = true) const;
