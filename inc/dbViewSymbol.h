...
#define AcDbViewSym_Deprecated_ACHAR_Methods
#ifdef AcDbViewSym_Deprecated_ACHAR_Methods
...
inline Acad::ErrorStatus AcDbViewSymbol::getIdentifier(ACHAR*& pszName) const
{
    return ::acutGetAcStringConvertToAChar(this, &AcDbViewSymbol::getIdentifier, pszName);
}
#endif
