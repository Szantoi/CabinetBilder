...
/// </summary>
///
class  AcDbAssocVertexActionParam : public AcDbAssocActionParam
{
public:
    ACDB_DECLARE_MEMBERS(AcDbAssocVertexActionParam);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject explanation. </param>
    ///
    ACDBCORE2D_PORT explicit AcDbAssocVertexActionParam(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus setVertexRef(const AcDbVertexRef& vertexRef, bool isReadDependency = true, bool isWriteDependency = false, int dependencyOrder = 0);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getVertexRef(AcArray<AcDbVertexRef>& vertexRefs) const;
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus getVertexRef(AcDbVertexRef& vertexRef) const;
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus setVertexSubentityGeometry(const AcGePoint3d& newPosition);
