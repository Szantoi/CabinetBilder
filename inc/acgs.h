...
/// </description>
/// <param name="pKernel">Input graphics kernel to use.</param>
...
ACCORE_PORT Adesk::Boolean  acgsDrawableCached(AcGsGraphicsKernel* pKernel, AcGiDrawable* pDrawable);
...
/// </remarks>
ACCORE_PORT void acgsSetGsHighlightModel(AcGsGraphicsKernel* pKernel, const AcDbDatabase* pDb, AcGsModel* pModel);

/// <description>
/// Get an array of active graphics kernels.
/// </description>
/// <param name="result">Output array of graphics kernels</param>
/// <returns>
...
/// This is a convenience wrapper for AcGsManager::activeGraphicsKernels().
/// </remarks>
ACCORE_PORT bool acgsGetActiveGraphicsKernels(AcArray<AcGsGraphicsKernel*>& result);

/// <description>
/// Get an array of active graphics models.
/// </description>
/// <param name="result">Output array of graphics models</param>
/// <returns>
/// Returns true if there are one or more graphics models.  
/// </returns>
/// <remarks>
/// This function does not clear the result passed in before adding to it.
/// This is a convenience wrapper for AcGsManager::activeModels().
/// </remarks>
