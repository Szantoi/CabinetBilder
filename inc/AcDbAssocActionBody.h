...
{
public: 
    ACDB_DECLARE_MEMBERS(AcDbAssocActionBody);

    ACDBCORE2D_PORT explicit AcDbAssocActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT AcDbObjectId parentAction() const { return ownerId(); }
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus addParam(const AcString& paramName, AcRxClass* pParamClass, AcDbObjectId& paramId, int& paramIndex) const; 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus removeParam(const AcDbObjectId& paramId, bool alsoEraseIt) const; 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus setValueParamUnitType(const AcString& paramName, AcValue::UnitType unitType) const;
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus valueParamInputVariables(const AcString& paramName, AcDbObjectIdArray& variableIds) const;
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus setValueParamControlledObjectDep(const AcString& paramName, const AcDbObjectId& controlledObjectDepId) const;
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus updateValueParamFromControlledObject(const AcString& paramName) const;
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus transformAllConstantGeometryParams(const AcGeMatrix3d& transform) const;
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus getActionBodiesOnObject(const AcDbObject*  pObject,
...
public: 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getDependenciesOverride(bool readDependenciesWanted, 
                                                      bool writeDependenciesWanted,
                                                      AcDbObjectIdArray& dependencyIds) const
    { 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getDependentObjectsOverride(bool readDependenciesWanted,
                                                          bool writeDependenciesWanted,
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus isOwnedDependencyOverride(const AcDbAssocDependency* pDependency, 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus isExternalDependencyOverride(const AcDbAssocDependency* pDependency, 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus hasDependencyCachedValueOverride(const AcDbAssocDependency* pDependency,
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus isRelevantDependencyChangeOverride(const AcDbAssocDependency* pDependency,
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus areDependenciesOnTheSameThingOverride(const AcDbAssocDependency* pDependency1,
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus areDependenciesEqualOverride(const AcDbAssocDependency* pDependency1,
                                                           const AcDbAssocDependency* pDependency2,
                                                           bool& areEqual) const
    {
        ADESK_UNREFED_PARAM(pDependency1);
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus evaluateDependencyOverride(AcDbAssocDependency* pDependency)
    {
        ADESK_UNREFED_PARAM(pDependency);
        return Acad::eNotImplemented; 
    }
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus dependentObjectClonedOverride(const AcDbAssocDependency* pDependency, 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus addMoreObjectsToDeepCloneOverride(AcDbIdMapping& /*idMap*/, 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus postProcessAfterDeepCloneOverride(AcDbIdMapping& /*idMap*/) 
    { 
        return Acad::eNotImplemented;
    }
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus postProcessAfterDeepCloneCancelOverride(AcDbIdMapping& /*idMap*/)
    { 
        return Acad::eNotImplemented;
    }
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus ownedDependencyStatusChangedOverride(AcDbAssocDependency* pOwnedDependency, 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus isEqualToOverride(const AcDbAssocAction* pOtherAction, bool& isEqual) const
    {
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus evaluationPriorityOverride(AcDbAssocEvaluationPriority& priority) const
    {
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus getDependentActionsToEvaluateOverride(AcDbActionsToEvaluateCallback* pActionsToEvaluateCallback) const
    {
    ...
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus removeActionsControllingObjectOverride(AcDbObject* pControlledObject)
    {
    ...
    /// </para></summary>
    ///
    ACDBCORE2D_PORT virtual void auditAssociativeDataOverride(AcDbAssocStatus& parentActionHandling);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus notificationOverride(class AcDbAssocNotificationData* pNotificationData);
    ...
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus collectPersSubentNamingDataOverride(AcDbPersStepIdArray&   stepIds, 
    ...
    /// </param>
    //
    ACDBCORE2D_PORT virtual Acad::ErrorStatus clonePersSubentNamingDataOverride(class AcDbAssocPersSubentManagerCloner* pCloner);
