...
{
public: 
    ACDB_DECLARE_MEMBERS(AcDbAssocNetwork);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject explanation. </param>
    ///
    ACDBCORE2D_PORT explicit AcDbAssocNetwork(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    /// </returns>
    ///
    ACDBCORE2D_PORT const AcDbObjectIdArray& getActions() const;
    ...
    /// </returns>
    ///
    ACDBCORE2D_PORT const AcDbObjectIdArray& getActionsToEvaluate() const;
    ...
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus addAction(const AcDbObjectId& actionId, bool alsoSetAsDatabaseOwner);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus removeAction(const AcDbObjectId& actionId, bool alsoEraseIt);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus addActions(const AcDbObjectIdArray& actionIds, bool alsoSetAsDatabaseOwner);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus removeAllActions(bool alsoEraseThem);
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus ownedActionStatusChanged(AcDbAssocAction* pOwnedAction, 
    ...
    ///
    ACDBCORE2D_PORT static AcDbObjectId getInstanceFromDatabase(AcDbDatabase*   pDatabase,
    ...
    /// <returns> AcDbObjectId of the existing or newly created AcDbAssocNetwork. </returns>
    ///
    ACDBCORE2D_PORT static AcDbObjectId getInstanceFromObject(const AcDbObjectId& owningObjectId,
                                              bool                createIfDoesNotExist,
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus removeInstanceFromObject(const AcDbObjectId& owningObjectId,
                                                      bool                alsoEraseIt,
                                                      const AcString&     dictionaryKey = ACRX_T(""));
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDBCORE2D_PORT static Acad::ErrorStatus removeInstanceFromDatabase(AcDbDatabase*   pDatabase,
                                                        bool            alsoEraseIt,
                                                        const AcString& dictionaryKey = ACRX_T(""));
...
public:
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT explicit AcDbAssocNetworkIterator(const AcDbAssocNetwork* pNetwork) 
    ...
    ///
    ACDBCORE2D_PORT AcDbObjectId current() const 
    { 
    ...
    /// </summary> 
    ///
    ACDBCORE2D_PORT void reset() { mIndex = -1; }
