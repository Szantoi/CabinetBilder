...
/// </summary>
///
class  AcDbAssocNetworkSurfaceActionBody : public AcDbAssocPathBasedSurfaceActionBody
{
public:
    GEOMENT_DECLARE_MEMBERS(AcDbAssocNetworkSurfaceActionBody);

    /// <summary> Default constructor. </summary>
    /// <param name="createImpObject"> See AcDbAssocCreateImpObject explanation. </param>
    ///
    ACDB_PORT explicit AcDbAssocNetworkSurfaceActionBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    ///
    ACDB_PORT Acad::ErrorStatus getContinuity( AcDbAssocLoftedSurfaceActionBody::ProfileType type, 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus setContinuity( AcDbAssocLoftedSurfaceActionBody::ProfileType type, 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus getBulge( AcDbAssocLoftedSurfaceActionBody::ProfileType type, 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    ACDB_PORT Acad::ErrorStatus setBulge( AcDbAssocLoftedSurfaceActionBody::ProfileType type, 
