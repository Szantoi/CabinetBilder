...
{
public: 
    ACDB_DECLARE_MEMBERS(AcDbAssocDependencyBody);

    ACDBCORE2D_PORT explicit AcDbAssocDependencyBody(AcDbAssocCreateImpObject createImpObject = kAcDbAssocCreateImpObject);
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT AcDbObjectId parentDependency() const { return ownerId(); }
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT bool isAttachedToObject() const { return !dependentOnObject().isNull(); }
...
public: 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus isDependentOnTheSameThingAsOverride(const AcDbAssocDependency* pOtherDependency, 
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual Acad::ErrorStatus isEqualToOverride(const AcDbAssocDependency* pOtherDependency, bool& isEqual) const
    { 
        ADESK_UNREFED_PARAM(pOtherDependency);
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual void erasedOverride(const AcDbObject* pDbObj, Adesk::Boolean isErasing)
    {
    ...
    /// </summary>
    ///
    ACDBCORE2D_PORT virtual void modifiedOverride(const AcDbObject* pDbObj) 
    {
        ADESK_UNREFED_PARAM(pDbObj);
    }
