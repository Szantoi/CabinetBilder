...
// methods
        ...
        // checks whether this path points to a virtual
        //  file/directory.
...
// methods
        ...
        // Deprecated, please use above GetFileSystemType() method instead
        ADESK_DEPRECATED static FS_TYPE GetFileSystem(AcString& vol_name);
